(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('moment'), require('@angular/forms'), require('pinyinlite/index_full'), require('rxjs'), require('lodash'), require('rxjs/operators'), require('@er/types'), require('elastic-builder')) :
    typeof define === 'function' && define.amd ? define('@er/utils', ['exports', 'moment', '@angular/forms', 'pinyinlite/index_full', 'rxjs', 'lodash', 'rxjs/operators', '@er/types', 'elastic-builder'], factory) :
    (factory((global.er = global.er || {}, global.er.utils = {}),global.momentNs,global.ng.forms,global.pinyinlite,global.rxjs,global._,global.rxjs.operators,global.types,global.esb));
}(this, (function (exports,momentNs,forms,pinyinlite,rxjs,_,operators,types,esb) { 'use strict';

    pinyinlite = pinyinlite && pinyinlite.hasOwnProperty('default') ? pinyinlite['default'] : pinyinlite;
    ...
    ***************************************************************************** */
    ...
    var CommonsUtils = /** @class */ (function () {
         ...
         */
            function (object) {
                /** @type {?} */
                var type = types.VarType.UNKNOWN;
                if (object === null) {
                    type = types.VarType.NULL;
                }
                else if (object === undefined) {
                    type = types.VarType.UNDEFINED;
                }
                else if (object === true || object === false) {
                    type = types.VarType.BOOLEAN;
                }
                if (type !== types.VarType.UNKNOWN) {
                    return type;
                }
                /** @type {?} */
                ...
                if (objectType === 'string') {
                    ...
                    //   return VarType.DATE;
                    // }
                    type = types.VarType.STRING;
                }
                else if (objectType === 'number') {
                    type = types.VarType.NUMBER;
                }
                else if (objectType === 'function') {
                    type = types.VarType.FUNCTION;
                }
                if (object.constructor === [].constructor) {
                    type = types.VarType.ARRAY;
                }
                else if (object.constructor === {}.constructor) {
                    type = types.VarType.JSON;
                }
                return type;
            };
        /**
         ...
         */
            function (obj) {
                return CommonsUtils.getVarType(obj) === types.VarType.STRING;
            };
        /**
         * @param {?} obj
         * @return {?}
         ...
         */
            function (obj) {
                return CommonsUtils.getVarType(obj) === types.VarType.BOOLEAN;
            };
        /**
         * @param {?} s
         * @return {?}
         ...
         */
            function (obj) {
                return CommonsUtils.getVarType(obj) === types.VarType.ARRAY;
            };
        /**
         * @param {?} obj
         * @return {?}
         ...
         */
            function (obj) {
                return CommonsUtils.getVarType(obj) === types.VarType.NUMBER;
            };
        /**
         * @param {?} obj
         * @return {?}
         ...
         */
            function (obj) {
                return CommonsUtils.getVarType(obj) === types.VarType.JSON;
            };
        /**
         * @param {?} obj
         * @return {?}
         ...
         */
            function (obj) {
                return CommonsUtils.getVarType(obj) === types.VarType.FUNCTION;
            };
        /**
         * @param {?} str
         * @return {?}
         ...
         */
            function (obj1) {
                ...
                return _.merge.apply(null, __spread([obj1], obj2));
            };
        /**
         * @param {?} obj
         * @param {?} predicate
         ...
         */
            function (obj1) {
                ...
                return _.defaultsDeep.apply(undefined, __spread([obj1], obj2));
            };
        /**
         * @param {?} obj1
         * @param {?} obj2
         ...
         */
            function (obj) {
                switch (CommonsUtils.getVarType(obj)) {
                    case types.VarType.NULL:
                    case types.VarType.UNDEFINED:
                        return '';
                    case types.VarType.ARRAY: {
                        /** @type {?} */
                        var a_1 = [];
                        obj.forEach(function (o) { return a_1.push(CommonsUtils.toString(o)); });
                        return "[" + a_1.join(',') + "]";
                    }
                    case types.VarType.JSON:
    ...
    var RegUtils = /** @class */ (function () {
         ...
         */
            function (pattern) {
                ...
                if (CommonsUtils.isString(pattern)) {
                    if (pattern === 'letter') {
                        exp = types.RegPatterns.letter;
                    }
                    else if (pattern === 'digit') {
                        exp = types.RegPatterns.digit;
                    }
                    else if (pattern === 'character') {
                        exp = types.RegPatterns.character;
                    }
                    else if (pattern === 'integer') {
                        exp = types.RegPatterns.integer;
                    }
                    else if (pattern === 'numeric') {
                        exp = types.RegPatterns.numeric;
                    }
                    else {
    ...
    var BrowserOsUtils = /** @class */ (function () {
         ...
         */
            function () {
                /** @type {?} */
                var result = [
                    types.Devices.DEVICES.ANDROID,
                    types.Devices.DEVICES.IPHONE,
                    types.Devices.DEVICES.I_POD,
                    types.Devices.DEVICES.BLACKBERRY,
                    types.Devices.DEVICES.FIREFOX_OS,
                    types.Devices.DEVICES.WINDOWS_PHONE,
                    types.Devices.DEVICES.VITA
                ].some(function (item) {
         ...
         */
            function () {
                /** @type {?} */
                var result = [
                    types.Devices.DEVICES.PS4,
                    types.Devices.DEVICES.CHROME_BOOK,
                    types.Devices.DEVICES.UNKNOWN
                ].some(function (item) {
                    return BrowserOsUtils.device_info.device === item;
                });
                return result;
         ...
         */
            function () {
                ...
                mappings.forEach(function (mapping) {
                    BrowserOsUtils[mapping.prop] = Object.keys(types.Devices[mapping.const]).reduce(function (obj, item) {
                        obj[types.Devices[mapping.const][item]] = RegUtils.test(BrowserOsUtils.ua, types.Devices[mapping.const + "_RE"][item]);
                        return obj;
                    }, {});
                });
                mappings.forEach(function (mapping) {
                    BrowserOsUtils[mapping.prop] = Object.keys(types.Devices[mapping.const])
                        .map(function (key) {
                        return types.Devices[mapping.const][key];
                    }).reduce(function (previousValue, currentValue) {
                        return (previousValue === types.Devices[mapping.const].UNKNOWN && BrowserOsUtils[mapping.prop][currentValue])
                            ? currentValue : previousValue;
                    }, types.Devices[mapping.const].UNKNOWN);
                });
                BrowserOsUtils.browser_version = '0';
                if (BrowserOsUtils.browser !== types.Devices.BROWSERS.UNKNOWN) {
                    /** @type {?} */
                    var re = types.Devices.BROWSER_VERSIONS_RE[BrowserOsUtils.browser];
                    /** @type {?} */
    ...
    var ColorUtils = /** @class */ (function () {
         ...
         */
            function () {
                if (UI_COLORS_COUNT === -1) {
                    UI_COLORS_COUNT = Object.keys(types.UI_COLORS).length;
                }
         ...
         */
            function (by, offset) {
                ...
                /** @type {?} */
                var matched = 'pink';
                Object.keys(types.UI_COLORS).some(function (color, index) {
                    if (index === colorIndex) {
                        matched = types.UI_COLORS[color];
                        return true;
                    }
                    else {
                        return false;
    ...
    var DevicesUtils = /** @class */ (function () {
         ...
         */
            function () {
                ...
                return rxjs.from(navigator.mediaDevices.enumerateDevices())
                    .pipe(operators.map(function (devices) {
                    var e_1, _a;
                    /** @type {?} */
                    var mediaDevices = [];
                    try {
         ...
         */
            function () {
                /** @type {?} */
                var videos = DevicesUtils.getMediaDevices().pipe(operators.map(function (devices) { return devices.filter(function (device) { return device.kind === 'videoinput'; }); }));
                return videos;
            };
        /**
         * @return {?}
         ...
         */
            function () {
                /** @type {?} */
                var audios = DevicesUtils.getMediaDevices().pipe(operators.map(function (devices) { return devices.filter(function (device) { return device.kind === 'audioinput'; }); }));
                return audios;
            };
        /**
         * @return {?}
         ...
         */
            function (constrains, deviceId) {
                if (!navigator.mediaDevices) {
                    rxjs.throwError('Can\'t get user media, this is not supported.');
                }
                /** @type {?} */
                ...
                return rxjs.from(navigator.mediaDevices.getUserMedia(constrains))
                    .pipe(operators.map(function (stream) { return stream; }), operators.catchError(function (err) { return rxjs.throwError(err); }));
            };
        /**
         * @param {?} mediaStream
         * @return {?}
         ...
         */
            function (videoEle, canvasEle) {
                ...
                return rxjs.of({ dataUrl: dataUrl, mimeType: mimeType });
            };
        return DevicesUtils;
    }());
     ...
     */
    /** @type {?} */
    var APP_STORE = new rxjs.BehaviorSubject({});
         ...
         */
            function (path, createWhenAbsent) {
                ...
                if (!storeItem && createWhenAbsent) {
                    storeItem = {
                        state: new rxjs.BehaviorSubject(undefined),
    ...
    var DateUtils = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var date;
                /** @type {?} */
                var dateState = StatesUtils.getValue(types.StateNames.serverTime);
                if (dateState) {
                    date = dateState.date;
                }
                else {
    ...
    var FileUtils = /** @class */ (function () {
         ...
         */
            function (file, readAs) {
                ...
                /** @type {?} */
                var fileReader$ = rxjs.fromEvent(reader, 'load').pipe(operators.map(function (e) { return e.target.result; }), operators.first());
                switch (readAs || types.ReadAs.BINARY) {
                    case types.ReadAs.ARRAY:
                        reader.readAsArrayBuffer(file);
                        break;
                    case types.ReadAs.BINARY:
                        reader.readAsBinaryString(file);
                        break;
                    case types.ReadAs.URL:
                        reader.readAsDataURL(file);
                        break;
                    case types.ReadAs.TEXT:
    ...
    var DEFAULT_APP_CONFIG = {
        ...
        auth: {
            ...
            loginApiOptions: { serverType: types.ApiServerType.App },
            loginSuccessRouter: '/',
            logoutSuccessRouter: 'user/login'
        },
        alert: {},
        announce: {},
        notify: types.NotifyType.ALERT,
    ...
    var DialogUtils = /** @class */ (function () {
         ...
         */
            function (header, content, options) {
                /** @type {?} */
                var state = StatesUtils.create(types.StateNames.confirm, __assign({ header: header,
                    content: content }, options, { open: true }));
                return state.pipe(operators.filter(function (stateValue) { return stateValue && !stateValue.open; }), operators.map(function (_a) {
         ...
         */
            function (header, content, options) {
                /** @type {?} */
                var state = StatesUtils.create(types.StateNames.popup, __assign({ header: header,
         ...
         */
            function (file) {
                if (typeof file === 'string' && file.startsWith('data:')) {
                    ...
                    var reader = new FileReader();
                    /** @type {?} */
                    var fileContent$ = rxjs.fromEvent(reader, 'load')
            ...
            function (treeNodes, value, props) {
                ...
                if (treeNodes) {
                    for (var i = 0; i < treeNodes.length; i++) {
                        if (value[props.dataItemProps.idKey] === treeNodes[i][types.DEFAULT_TREE_NODE_KEYS.dataKey][props.dataItemProps.idKey]) {
                            found = treeNodes[i];
                            break;
                        }
                        if (treeNodes[i].hasOwnProperty(types.DEFAULT_TREE_NODE_KEYS.childrenKey)) {
                            /** @type {?} */
                            var children = treeNodes[i][types.DEFAULT_TREE_NODE_KEYS.childrenKey];
    ...
    var AnnounceUtils = /** @class */ (function () {
         ...
         */
            function (options) {
                ...
                StatesUtils.create(types.StateNames.notify, __assign({}, notify, { type: types.NotifyType.ANNOUNCE }));
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, ( /** @type {?} */(__assign({}, notify, { level: types.NotifyLevel.ERROR, type: types.NotifyType.ANNOUNCE }))));
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, ( /** @type {?} */(__assign({}, notify, { level: types.NotifyLevel.SUCCESS, type: types.NotifyType.ANNOUNCE }))));
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, ( /** @type {?} */(__assign({}, notify, { level: types.NotifyLevel.WARN, type: types.NotifyType.ANNOUNCE }))));
            };
    ...
    var NotifyUtils = /** @class */ (function () {
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, notify);
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, ( /** @type {?} */(__assign({}, notify, { level: types.NotifyLevel.ERROR }))));
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, ( /** @type {?} */(__assign({}, notify, { level: types.NotifyLevel.SUCCESS }))));
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (options) {
                /** @type {?} */
                var notify = CommonsUtils.getObjWhenStr(options, 'message');
                StatesUtils.create(types.StateNames.notify, ( /** @type {?} */(__assign({}, notify, { level: types.NotifyLevel.WARN }))));
            };
        return NotifyUtils;
    }());
    ...
    var RxUtils = /** @class */ (function () {
         ...
         */
            function (count, wait) {
                /** @type {?} */
                var tap = operators.retryWhen(function (errors) {
                    return errors.pipe(operators.scan(function (acc, error) {
                        if (acc >= count || -1) {
                            throw error;
                        }
                        return acc + 1;
                    }, 0), operators.delay(wait));
                });
                return tap;
            };
        return RxUtils;
    ...
    var FormatStringTokenizer = /** @class */ (function () {
         ...
         */
            function (format, includeBracketsForDynamicValues) {
                if (includeBracketsForDynamicValues === void 0) {
    ...
    var EsUtils = /** @class */ (function () {
            ...
            function (options) {
                ...
                if (options.sort) {
                    ...
                    Object.keys(sorts_1).forEach(function (key) {
                        esSorts_1.push(esb.sort(key, sorts_1[key] || types.Order.ASC).unmappedType('string'));
                    });
                ...
                props.forEach(function (item) {
                    ...
                    switch (aggProp.method) {
                        ...
                        case types.AggMethods.HISTOGRAM:
                            ...
                            break;
                        case types.AggMethods.DATE_HISTOGRAM:
                            agg = esb.dateHistogramAggregation(aggName, aggProp.field);
                            if (aggProp.interval) {
                                (( /** @type {?} */(agg))).interval(aggProp.interval);
                            }
                            /** @type {?} */
                            var interval = aggProp.interval || types.AggInterval.DAY;
                            /** @type {?} */
                            var intervalProp = types.AggIntervalProps[interval];
                            ...
                            break;
                        case types.AggMethods.CUSTOMER:
                            agg = CommonsUtils.getValue(aggProp.aggs, aggProp);
                            break;
                        case types.AggMethods.COUNT:
         ...
         */
            function (body, options) {
                ...
                if (body instanceof esb.RequestBodySearch) {
                ...
                if (!CommonsUtils.isEmpty(_body.sort)) {
                    ...
                    Object.keys(sorts_2).forEach(function (key) {
                        var _a;
                        esSorts_2.push((_a = {}, _a[key] = { order: sorts_2[key] || types.Order.ASC, 'unmapped_type': 'string' }, _a));
                    });
         ...
         */
            function (ruleSet) {
                ...
                return (function parse(data) {
                    if (!data['condition']) {
                        data['condition'] = types.DEFAULT_ES_QUERY_CONDITION || types.DEFAULT_QUERY_CONDITION;
                    }
                    ...
                    data['rules'].forEach(function (rule) {
                        ...
                        var make_query = function (aRule) {
                            /** @type {?} */
                            var operator = types.ES_QUERY_OPERATORS[aRule.operator];
    ...
    exports.Utils = Utils;
    exports.BrowserOsUtils = BrowserOsUtils;
    exports.ChartUtils = ChartUtils;
    exports.ColorUtils = ColorUtils;
    exports.CopierUtils = CopierUtils;
    exports.DevicesUtils = DevicesUtils;
    exports.DateUtils = DateUtils;
    exports.DataEntityUtils = DataEntityUtils;
    ...
    exports.RegUtils = RegUtils;
    exports.ImageUtil = ImageUtil;
    exports.PagerUtil = PagerUtil;
    exports.TreeUtils = TreeUtils;
    exports.AnnounceUtils = AnnounceUtils;
    exports.NotifyUtils = NotifyUtils;
    exports.RxUtils = RxUtils;
    exports.UrlUtils = UrlUtils;
    exports.TokenizerUtils = TokenizerUtils;
    exports.ExtractionResult = ExtractionResult;
    exports.FormatStringTokenType = FormatStringTokenType;
    exports.FormatStringToken = FormatStringToken;
    exports.FormatStringTokenizer = FormatStringTokenizer;
...
//# sourceMappingURL=er-utils.umd.js.map