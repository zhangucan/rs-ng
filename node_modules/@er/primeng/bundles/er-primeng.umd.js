(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@er/image-editor'), require('@angular/platform-browser'), require('primeng/api'), require('elastic-builder'), require('@er/validate'), require('@angular/router'), require('@er/presets'), require('primeng/primeng'), require('primeng/table'), require('primeng/toast'), require('rxjs'), require('@angular/forms'), require('@er/types'), require('rxjs/operators'), require('@angular/animations'), require('@angular/core'), require('@er/core'), require('@er/utils')) :
    typeof define === 'function' && define.amd ? define('@er/primeng', ['exports', '@er/image-editor', '@angular/platform-browser', 'primeng/api', 'elastic-builder', '@er/validate', '@angular/router', '@er/presets', 'primeng/primeng', 'primeng/table', 'primeng/toast', 'rxjs', '@angular/forms', '@er/types', 'rxjs/operators', '@angular/animations', '@angular/core', '@er/core', '@er/utils'], factory) :
    (factory((global.er = global.er || {}, global.er.primeng = {}),global.imageEditor,global.ng.platformBrowser,global.api,global.esb,global.validate,global.ng.router,global.presets,global.primeng,global.table,global.toast,global.rxjs,global.ng.forms,global.types,global.rxjs.operators,global.ng.animations,global.ng.core,global.core$1,global.utils));
}(this, (function (exports,imageEditor,platformBrowser,api,esb,validate,router,presets,primeng,table,toast,rxjs,forms,types,operators,animations,core,core$1,utils) { 'use strict';
    ...
    ***************************************************************************** */
         ...
         */
            function () {
                ...
                if (this.$props.$ext.dataItemProps) {
                    if (!this.$props.field && utils.CommonsUtils.isString(this.$props.$ext.dataItemProps.labelKey)) {
        ...
        PngAutoCompleteComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                ...
                                useExisting: core.forwardRef(function () { return PngAutoCompleteComponent; }),
                                multi: true
                            }],
    ...
    }(core$1.DataAwareControlWrapperComponent));
    ...
    var PngButtonComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PngButtonComponent.prototype, "isHidden", {
             ...
             */ function () {
                if (this.$props && this.$props.hidden) {
                    return utils.CommonsUtils.getValue(this.$props.hidden, this.outputContext) || false;
                }
                return false;
            },
            enumerable: true,
         ...
         */
            function () {
                var _this = this;
                /** @type {?} */
                var btnProps = utils.CommonsUtils.copy(this.$props || {});
                if (btnProps.menu) {
                ...
                this.$props = __assign({}, presets.DEFAULT_BUTTON_PROPS, btnProps);
            };
        /**
         * @param {?} command
         * @param {?} event
    ...
    var PngCalendarComponent = /** @class */ (function (_super) {
        ...
        function PngCalendarComponent() {
            ...
            _this.today = utils.DateUtils.getDay();
            _this.templateNames = {
                header: 'header',
                footer: 'footer',
                date: 'date'
         ...
         */
            function (model) {
                if (model) {
                    return utils.DateUtils.toDate(model);
                }
            };
        PngCalendarComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngCalendarComponent; }),
                                multi: true
                            }]
                    }] }
        ];
        return PngCalendarComponent;
    }(core$1.ControlWrapperComponent));
    ...
    var PngChartComponent = /** @class */ (function (_super) {
        ...
        function PngChartComponent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.type = types.ChartType.BAR;
            _this.plugins = [];
            ...
            _this.onDataSelect = new core.EventEmitter();
            _this.data$ = new rxjs.BehaviorSubject(undefined);
            _this.chartTypes = [
                { label: '柱状图', value: types.ChartType.BAR, icon: 'fa fa-bar-chart' },
                { label: '圆饼图', value: types.ChartType.PIE, icon: 'fa fa-pie-chart' },
                { label: '曲线图', value: types.ChartType.LINE, icon: 'fa fa-line-chart' },
                { label: '雷达图', value: types.ChartType.RADAR, icon: 'fa fa-bar' },
                { label: '区域图', value: types.ChartType.AREA, icon: 'fa fa-area-chart' },
                { label: '环形图', value: types.ChartType.DOUGHNUT, icon: 'fa fa-circle' }
            ];
            return _this;
        }
         ...
         */
            function () {
                var _this = this;
                if (!this.$id) {
                    this.$id = utils.IdUtils.getRandom();
                }
                if (this.rawData) {
                    ...
                    core$1.ApiUtils.batchFetch(ds, this.$id)
         ...
         */
            function (rawData) {
                var _this = this;
                if (!utils.CommonsUtils.isEmpty(rawData)) {
                    /** @type {?} */
                    var data = void 0;
                    /** @type {?} */
                    var datasets_1 = [];
                    /** @type {?} */
                    var labels_1 = [];
                    if (utils.CommonsUtils.isFunction(this.dimensions)) {
                        data = (( /** @type {?} */(this.dimensions)))(rawData);
                    }
                    else {
                        if (this.dimensions) {
                            /** @type {?} */
                            var dimensions = utils.CommonsUtils.getArrayValue(this.dimensions);
                            dimensions.forEach(function (dimension, index) {
                                if (_this.resolveDimension) {
                                    dimension = _this.resolveDimension.method(dimension);
                                }
                                /** @type {?} */
                                var chartData = utils.ChartUtils.buildChartData(rawData, {
                                    type: _this.type,
                                    dimension: dimension,
                            ...
                            data = utils.ChartUtils.buildChartData(rawData, {
                                type: this.type,
        ...
        PngChartComponent.propDecorators = {
            ...
            rawData: [{ type: core.Input }],
            options: [{ type: core.Input }],
            caption: [{ type: core.Input }],
            captionIcon: [{ type: core.Input }],
            query: [{ type: core.Input }],
            plugins: [{ type: core.Input }],
            width: [{ type: core.Input }],
            height: [{ type: core.Input }],
            responsive: [{ type: core.Input }],
            switchable: [{ type: core.Input }],
            dataSource: [{ type: core.Input }],
            dataItemProps: [{ type: core.Input }],
            dimensions: [{ type: core.Input }],
            resolveDataSource: [{ type: core.Input }],
            resolveDimension: [{ type: core.Input }],
    ...
    var PngCheckBoxComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PngCheckBoxComponent.prototype, "chkValue", {
             ...
             */ function (values) {
                ...
                if (utils.CommonsUtils.isArray(data)) {
                    /** @type {?} */
                    var objectValues_1 = [];
                    values.forEach(function (value) {
                        ...
                        if (matched.length === 1) {
                            objectValues_1.push(utils.DataItemUtils.getItemValue(matched[0], _this.valueKey));
                        }
                    });
        ...
        Object.defineProperty(PngCheckBoxComponent.prototype, "dataKey", {
             ...
             * @return {?}
             */ function () {
                return utils.CommonsUtils.get(this.$props, '$ext.dataItemProps.idKey', 'value');
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PngCheckBoxComponent.prototype, "valueKey", {
             ...
             * @return {?}
             */ function () {
                return utils.CommonsUtils.get(this.$props, '$ext.dataItemProps.valueKey', 'value');
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
            function (model) {
                ...
                if (this.$props && !this.$props.label && model) {
                    /** @type {?} */
                    var models = utils.CommonsUtils.getArrayValue(model);
                    this._chkValue = [];
                    models.forEach(function (m) {
                        if (utils.CommonsUtils.isJson(m)) {
                            _this._chkValue.push(utils.DataItemUtils.getItemValue(m, _this.dataKey));
                        }
                        else {
        ...
        PngCheckBoxComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngCheckBoxComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var PngConfirmDialogComponent = /** @class */ (function (_super) {
        ...
        function PngConfirmDialogComponent(confirmationService, cd) {
            ...
            _this.onReject = new core.EventEmitter();
            _this.dlgOptions = {};
            return _this;
        }
        /**
         ...
         */
            function () {
                ...
                this.$subscriptions = utils.StatesUtils.observe(types.StateNames.confirm)
                    .pipe(operators.filter(function (state) { return state && state.open; }))
         ...
         */
            function () {
                ...
                utils.StatesUtils.create(types.StateNames.confirm, {
                    open: false,
                    accept: true,
                    reject: false
                });
        ...
        /** @nocollapse */
        PngConfirmDialogComponent.ctorParameters = function () {
            return [
    ...
    var PngFileUploadComponent = /** @class */ (function (_super) {
        ...
        function PngFileUploadComponent(imageToolsService, sanitizer, cd) {
            ...
            _this.cd = cd;
            _this.selectedFiles$ = new rxjs.BehaviorSubject([]);
            _this.uploadedFiles = [];
            _this.$defaultProps = DEFAULT_PNG_FILE_UPLOAD_PROPS;
            _this.showUpload = true;
            _this.uploadProgress$ = new rxjs.Subject();
        ...
        Object.defineProperty(PngFileUploadComponent.prototype, "uploadValue", {
             ...
             */ function () {
                ...
                return utils.CommonsUtils.getArrayValue(this.value);
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
            function () {
                _super.prototype.onPropsInit.call(this);
                if (!this.$props.url) {
                    this.$props.url = "" + utils.ConfigUtils.getConfig().api.servers.image.uri;
                    core$1.LogUtils.debug(this, '文件上传路径', this.$props.url);
                }
            };
        /**
         * @param {?} event
         ...
         */
            function (fileId) {
                var _this = this;
                this.$subscriptions = core$1.HttpUtils.request({
                    uri: utils.ConfigUtils.getConfig().api.servers.image.uri + "/" + fileId,
         ...
         */
            function (event) {
                ...
                if (!utils.CommonsUtils.isEmpty(this.fileAttrs)) {
        ...
        PngFileUploadComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngFileUploadComponent; }),
                                multi: true
                            }]
                    }] }
        ];
        /** @nocollapse */
        PngFileUploadComponent.ctorParameters = function () {
            return [
                { type: imageEditor.ImageToolsService },
    ...
    var PngImageComponent = /** @class */ (function (_super) {
        ...
        function PngImageComponent(cd, sanitizer) {
            ...
            _this.descriptionChange = new core.EventEmitter();
            return _this;
        }
         ...
         */
            function (changes) {
                var _this = this;
                if (changes.src) {
                    if (utils.CommonsUtils.isArray(this.src)) {
                        if (this.src.length === 1) {
                            ...
                            (( /** @type {?} */(this.src))).forEach(function (image) {
                                if (utils.CommonsUtils.isString(image)) {
                ...
                if (changes.fileId) {
                    ...
                    if (!this.fileId) {
                        ...
                        if (utils.CommonsUtils.isArray(this.fileId)) {
                        ...
                        core$1.HttpUtils.request({
                            uri: utils.ConfigUtils.getConfig().api.servers['image'].uri + "/" + fileId_1 + (this.size ? '?' + this.size : ''),
                            observe: 'events',
                            responseType: types.HttpResponseType.BLOB
                            ...
                            _this.fullImage = utils.ConfigUtils.getConfig().api.servers['image'].uri + "/" + fileId_1;
                            /** @type {?} */
         ...
         */
            function () {
                if (this.images) {
                    ...
                    utils.DialogUtils.info('图片预览', this.imageViewTpl, ( /** @type {?} */({})));
                }
            };
        ...
        /** @nocollapse */
        PngImageComponent.ctorParameters = function () {
            return [
                { type: core.ChangeDetectorRef },
                { type: platformBrowser.DomSanitizer }
            ];
        ...
        PngImageComponent.propDecorators = {
            ...
            styleClass: [{ type: core.Input }],
            style: [{ type: core.Input }],
            imageStyleClass: [{ type: core.Input }],
            imageStyle: [{ type: core.Input }],
            descriptionStyleClass: [{ type: core.Input }],
            descriptionStyle: [{ type: core.Input }],
            boxStyleClass: [{ type: core.Input }],
            boxStyle: [{ type: core.Input }],
            imageViewStyleClass: [{ type: core.Input }],
            imageViewStyle: [{ type: core.Input }],
            showDescription: [{ type: core.Input }],
            size: [{ type: core.Input }],
            fileId: [{ type: core.Input }],
            imageViewTpl: [{ type: core.ViewChild, args: ['imageView',] }],
            imageViewer: [{ type: core.ViewChild, args: ['imagesView',] }],
            descriptionChange: [{ type: core.Output }]
        };
    ...
    var PngInputComponent = /** @class */ (function (_super) {
        ...
        PngInputComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngInputComponent; }),
                                multi: true
                            }],
    ...
    var PngListBoxComponent = /** @class */ (function (_super) {
        ...
        PngListBoxComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngListBoxComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var PngMultiSelectComponent = /** @class */ (function (_super) {
        ...
        PngMultiSelectComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngMultiSelectComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var DEFAULT_ALERT_PROPS = {
        ...
        closable: true,
        autoZIndex: true,
        position: types.UiPosition.rightTop
    };
    var PngAlertComponent = /** @class */ (function (_super) {
        ...
        function PngAlertComponent(messageService, cd) {
            ...
            _this.cd = cd;
            _this.alert = __assign({}, DEFAULT_ALERT_PROPS, utils.ConfigUtils.getConfig().alert || {});
            _this.defaultNotifyType = utils.ConfigUtils.getConfig().notify || types.NotifyType.ALERT;
            return _this;
        }
        /**
         * @return {?}
         ...
         */
            function () {
                var _this = this;
                this.$subscriptions = utils.StatesUtils.observe(types.StateNames.notify)
                    .pipe(operators.filter(function (notify) { return notify && notify.message; }), operators.filter(function (notify) { return notify.type === types.NotifyType.ALERT || (!notify.type && _this.defaultNotifyType === types.NotifyType.ALERT); })).subscribe(function (notify) {
                    /** @type {?} */
         ...
         */
            function (notify) {
                return {
                    key: notify.key,
                    severity: notify.level || types.NotifyLevel.INFO,
                    summary: notify.title,
                    detail: notify.message,
                    sticky: notify.sticky || false,
                    life: notify.duration || notify.level === types.NotifyLevel.ERROR ? DEFAULT_ALERT_PROPS.duration * 2 : DEFAULT_ALERT_PROPS.duration,
        ...
        /** @nocollapse */
        PngAlertComponent.ctorParameters = function () {
            return [
    ...
    var PngAnnounceComponent = /** @class */ (function (_super) {
        ...
        function PngAnnounceComponent(messageService, cd) {
            ...
            _this.messageService = messageService;
            _this.cd = cd;
            _this.announce = __assign({}, DEFAULT_ANNOUNCE_PROPS, utils.ConfigUtils.getConfig().announce || {});
            _this.defaultNotifyType = utils.ConfigUtils.getConfig().notify;
            return _this;
        }
        /**
         * @return {?}
         ...
         */
            function () {
                var _this = this;
                this.$subscriptions = utils.StatesUtils.observe(types.StateNames.notify)
                    .pipe(operators.filter(function (notify) { return notify && notify.message; }), operators.filter(function (notify) { return notify.type === types.NotifyType.ANNOUNCE || (!notify.type && _this.defaultNotifyType === types.NotifyType.ANNOUNCE); })).subscribe(function (notify) {
                    /** @type {?} */
                    var model = _this.getNotifyModel(notify);
                    _this.messageService.add(model);
                    _this.cd.detectChanges();
        ...
        /** @nocollapse */
        PngAnnounceComponent.ctorParameters = function () {
            return [
                { type: api.MessageService },
                { type: core.ChangeDetectorRef }
            ];
    ...
    var PngOptionItemComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PngOptionItemComponent.prototype, "labels", {
             ...
             */ function () {
                /** @type {?} */
                var _label = utils.DataItemUtils.getItemLabel(this.item, this.props.dropDownOptionKey || this.props.labelKey || 'label');
    ...
    var PngOverlayPanelComponent = /** @class */ (function (_super) {
        ...
        PngOverlayPanelComponent.propDecorators = {
            content: [{ type: core.Input }],
            context: [{ type: core.Input }],
            panel: [{ type: core.ViewChild, args: [primeng.OverlayPanel,] }]
        };
    ...
    var PngPanelComponent = /** @class */ (function (_super) {
            ...
            function () {
                ...
                if (titleBar) {
                    if (this.barStyleClass) {
                        utils.DomUtils.addClasses(titleBar, this.barStyleClass);
                    }
                    if (this.barStyle) {
                        Object.keys(this.barStyle).forEach(function (name) {
                            core$1.DiUtils.get(core.Renderer2).setStyle(titleBar, name, _this.barStyle[name]);
                        });
                    }
                }
            };
        ...
        PngPanelComponent.propDecorators = {
            ...
            panelEle: [{ type: core.ViewChild, args: ['pngPanel', { read: core.ElementRef },] }]
        };
    ...
    var PngPopupDialogComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PngPopupDialogComponent.prototype, "options", {
             ...
             * @return {?}
             */ function (options) {
                this.dlgOptions$ = rxjs.of(this.resolveDlgOptions(options));
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
            function () {
                var _this = this;
                this.dlgOptions$ = utils.StatesUtils.observe(types.StateNames.popup)
                    .pipe(operators.filter(function (state) { return !!state; }), operators.map(function (options) { return _this.resolveDlgOptions(options); }), operators.takeUntil(this.destroyed$));
            };
        /**
         * @param {?} options
         * @return {?}
         ...
         */
            function (dlg, options) {
                ...
                utils.StatesUtils.create(types.StateNames.popup, { visible: false });
            };
    ...
    var PngRadioComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PngRadioComponent.prototype, "rbValue", {
             ...
             */ function (value) {
                ...
                if (utils.CommonsUtils.isArray(values)) {
                    /** @type {?} */
                    var matched = (( /** @type {?} */(values))).filter(function (v) { return v[_this.dataKey] === value; });
                    if (matched.length === 1) {
                        this.value = utils.DataItemUtils.getItemValue(matched[0], this.valueKey);
                    }
                    else {
                        this.value = null;
                    }
         ...
         */
            function (model) {
                if (utils.CommonsUtils.isJson(model)) {
                    this._rbValue = utils.DataItemUtils.getItemValue(model, this.dataKey);
                }
                return model;
            };
        PngRadioComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngRadioComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var PngRatingComponent = /** @class */ (function (_super) {
        ...
        PngRatingComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngRatingComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var PngSearchBoxComponent = /** @class */ (function (_super) {
        ...
        function PngSearchBoxComponent() {
            ...
            _this.onSearchChange = new core.EventEmitter();
            return _this;
        }
        /**
         * @return {?}
        ...
        PngSearchBoxComponent.propDecorators = {
            ...
            onSearchChange: [{ type: core.Output }]
        };
    ...
    var PngSelectButtonComponent = /** @class */ (function (_super) {
        ...
        PngSelectButtonComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngSelectButtonComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var PngSelectComponent = /** @class */ (function (_super) {
        ...
        PngSelectComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngSelectComponent; }),
                                multi: true
                            }],
        ...
        /** @nocollapse */
        PngSelectComponent.ctorParameters = function () {
            return [
                { type: core.ChangeDetectorRef }
            ];
        };
        PngSelectComponent.propDecorators = {
            dropDown: [{ type: core.ViewChild, args: [primeng.Dropdown,] }]
        };
    ...
    var PngSliderComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PngSliderComponent.prototype, "current", {
             ...
             * @return {?}
             */ function () {
                return utils.CommonsUtils.join(this.value, '——');
            },
            enumerable: true,
            configurable: true
        });
        ...
        PngSliderComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngSliderComponent; }),
                                multi: true
                            }]
                    }] }
        ];
    ...
    var defaultActionColumn = ( /** @type {?} */({
        ...
        filterable: false,
        aggable: false,
        dataAttr: types.DataAttr.BUTTONS,
        isActionColumn: true,
        cellContent: ( /** @type {?} */([]))
    }));
    /** @type {?} */
    ...
    var defaultDeleteButton = ( /** @type {?} */({
        ...
        onClick: function (event) {
            core$1.ApiUtils.deleteById(event.pngTable.$props.$ext.apiDataProps.apiEntry, event.row['id'])
                .subscribe(function () {
                event.pngTable.load();
                utils.StatesUtils.update(event.pngTable.$props.$id, { deleted: event.row['id'] });
            });
        }
    }));
    /** @type {?} */
    ...
    var PngTableUtils = /** @class */ (function () {
         ...
         */
            function (column) {
                ...
                column.dataField = utils.CommonsUtils.merge(core$1.DataFieldUtils.getFieldDefaultProps(column.dataField), column.dataField);
                ...
                if (!column.sortKey && column.dataField.dataType === types.DataType.JSON) {
                    sortKey = column.dataField.sortKey || column.dataField.key + "." + core$1.DataFieldUtils.getDefaultFieldName(column.dataField);
                }
                /** @type {?} */
                var id = column.id || column.key || column.dataField.key;
                utils.CommonsUtils.defaults(column, utils.CommonsUtils.pickBy({
                    id: id,
                    key: key,
                    label: label,
                    dataType: dataType,
                    ...
                    hidden: hidden,
                    sortKey: sortKey
                }, utils.CommonsUtils.lodash().identity));
            };
    ...
    var PngTableComponent = /** @class */ (function (_super) {
        ...
        function PngTableComponent(cd, router$$1, activatedRoute) {
            var _this = _super.call(this) || this;
            _this.cd = cd;
            _this.router = router$$1;
            _this.activatedRoute = activatedRoute;
            _this.OVERLAY_TYPE = types.OverlayType;
            _this.bodyData$ = new rxjs.BehaviorSubject([]);
            _this.columns$ = new rxjs.BehaviorSubject(undefined);
            _this.templateNames = {
                caption: 'caption',
            ...
            function () {
                ...
                if (this.$props.entity) {
                    if (!this.$props.caption || this.$props.caption['method']) {
                        /** @type {?} */
                        var caption = utils.CommonsUtils.getValue(this.$props.caption, this.$props.entity.label);
                ...
                if (this.$props.columns) {
                    ...
                    this.$props.columns.forEach(function (column) {
                        ...
                        utils.CommonsUtils.defaults(column, defaultPngColumnProps);
                        if (!column.order) {
                        ...
                        if (column.overlays) {
                            column.overlays = utils.CommonsUtils.getArrayValue(column.overlays);
                        }
                        if (column.headerOverlays) {
                            column.headerOverlays = utils.CommonsUtils.getArrayValue(column.headerOverlays);
                        }
                    });
                }
                ...
                if (this.$props.scrollable) {
                    utils.CommonsUtils.set(this.$props, 'style.width', this.$props.scrollWidth);
                }
                /** @type {?} */
                ...
                this.$subscriptions = utils.StatesUtils.observe(this.$id)
                    .pipe(operators.filter(function (state) { return !!state; }), operators.skip(1))
                    .subscribe(function (state) {
                    _this.table.first = 0;
                    _this.load(state);
                });
                ...
                utils.StatesUtils.create(this.$id, {
                    component: this
                }, true);
            };
        /**
         ...
         */
            function (event) {
                ...
                this.dataColumnNames = utils.CommonsUtils.compact(this.dataColumns.map(function (column) { return column.key; }));
                    ...
                    if (event.methods && event.methods.length > 0) {
                        event.methods.forEach(function (method) {
                            aggProps_1.push(( /** @type {?} */({
                                ...
                                method: types.AggMethodsProps[method]['key']
                            })));
                        });
                    }
                    column_1.aggProps = aggProps_1;
                    utils.StatesUtils.update(this.$id, {});
                }
            };
        /**
         * @param {?} event
         ...
         */
            function (event) {
                if (utils.CommonsUtils.isEmpty(event)) {
         ...
         */
            function (row) {
                return utils.CommonsUtils.getValue(this.$props.$ext.rowStyleClass, row);
            };
        /**
         * @param {?} row
         * @return {?}
         ...
         */
            function (row) {
                /** @type {?} */
                var style = utils.CommonsUtils.getValue(this.$props.$ext.rowStyle, row) || {};
                if (this.$props.$ext.rowHeight) {
         ...
         */
            function (column) {
                return utils.CommonsUtils.getValue(column.headerStyleClass, column);
            };
        /**
         * @param {?} column
         * @return {?}
         ...
         */
            function (column) {
                return utils.CommonsUtils.getValue(column.headerStyle, column);
            };
        /**
         * @param {?} event
         * @return {?}
         ...
         */
            function (event) {
                this.updateTouch();
                this.value = utils.DataItemUtils.getItemValue(event, this.$props.$ext.dataItemProps && this.$props.$ext.dataItemProps.valueKey);
            };
        /**
         * @param {?=} state
         * @return {?}
         ...
         */
            function (data) {
                /** @type {?} */
                var dataPath = utils.CommonsUtils.get(this.$props, '$ext.apiDataProps.dataPath');
         ...
         */
            function () {
                if (this.$props && this.$props.$id) {
                    utils.StatesUtils.deleteState(this.$props.$id);
                }
         ...
         */
            function (state) {
                ...
                if (state && (state.query || state.filter)) {
                    this.eventQuery = __spread(utils.CommonsUtils.getArrayValue(state['query'] || {}), utils.CommonsUtils.getArrayValue(state['filter'] || {}));
                }
                /** @type {?} */
                var filters = __spread(this.getColumnsFilters(), this.eventQuery, this.simpleQuery || [], utils.CommonsUtils.getArrayValue(this.complexQuery) || []);
                /** @type {?} */
                var gApiDataProps = utils.CommonsUtils.copy(utils.CommonsUtils.get(this.$props, '$ext.apiDataProps'));
                /** @type {?} */
                ...
                if (apiFilter['$and']) {
                    ...
                    apiFilter = utils.CommonsUtils.getArrayValue(apiFilter)
                        .concat(filters);
                }
                apiFilter = apiFilter.filter(function (f) { return !utils.CommonsUtils.isEmpty(f); });
                /** @type {?} */
                var aggProps = gApiDataProps.aggProps || {};
                aggProps = utils.CommonsUtils.getArrayValue(aggProps).concat(this.getColumnsAggs());
                ...
                sort = utils.CommonsUtils.getArrayValue(sort);
                /** @type {?} */
                ...
                if (tableSort) {
                    ...
                    sort.push((_a = {}, _a[sortKey] = tableMetaData.sortOrder === 1 ? types.Order.ASC : types.Order.DESC, _a));
                }
            ...
            function () {
                ...
                columns
                    ...
                    return column.filters.filter(function (f) { return f; })
                        ...
                        /** @type {?} */
                        var query;
                        switch (column.filterDataType || column.dataType || (column.dataField && column.dataField.dataType) || types.DataType.STRING) {
                            case types.DataType.NUMBER:
                            case types.DataType.DATE:
                                if (utils.CommonsUtils.isArray(f)) {
         ...
         */
            function (props) {
                ...
                if (actionColumnIndex >= 0) {
                    props.columns = utils.CommonsUtils.removeByIndex(props.columns, actionColumnIndex);
                }
                ...
                if (buttons.length > 0) {
                    actionColumn.cellContent = __spread(utils.CommonsUtils.getArrayValue(actionColumn.cellContent) || [], buttons);
                }
                if (actionColumn) {
        ...
        PngTableComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngTableComponent; }),
                                multi: true
                            }],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
        ...
        /** @nocollapse */
        PngTableComponent.ctorParameters = function () {
            return [
                { type: core.ChangeDetectorRef },
                { type: router.Router },
        ...
        PngTableComponent.propDecorators = {
            table: [{ type: core.ViewChild, args: ['pngTable',] }],
            overlayPanel: [{ type: core.ViewChild, args: ['overlayPanel',] }],
            popupMenu: [{ type: core.ViewChild, args: [primeng.Menu,] }]
        };
    ...
    var ValidateMessageTooltipComponent = /** @class */ (function () {
         ...
         */
            function () {
                /** @type {?} */
                var errMsgs = validate.ValidateUtils.getErrorMessage(this.control.errors, this.messages);
        ...
        /** @nocollapse */
        ValidateMessageTooltipComponent.ctorParameters = function () {
            return [
        ...
        ValidateMessageTooltipComponent.propDecorators = {
            ...
            in: [{ type: core.ViewChild, args: ['in',] }],
    ...
    var PngTreeComponent = /** @class */ (function (_super) {
        ...
        function PngTreeComponent(cd) {
            ...
            _this.onEmptyNode = new core.EventEmitter();
            _this.onLazyLoad = new core.EventEmitter();
         ...
         */
            function () {
                this.filtered = false;
                this.loading$ = core$1.HTTP_TAG_STATE$(this.$props.$id);
                if (this.$props.$ext.dataItems) {
                    this.data$.next(this.$props.$ext.dataItems);
                }
                utils.StatesUtils.create(this.$props.$id, {
                    component: this
                }, true);
            };
        /**
         ...
         */
            function (value) {
                ...
                if (utils.CommonsUtils.isArray(value)) {
                    selectedNodeValues = utils.CommonsUtils.flattenDeep(value).map(function (node) { return _this.getSelectedNodeValues(node); });
                }
                else if (utils.CommonsUtils.isJson(value)) {
                    selectedNodeValues = this.getSelectedNodeValues(value);
                }
                selectedNodeValues = utils.CommonsUtils.flatten(selectedNodeValues);
                selectedNodeValues = utils.CommonsUtils.unique(selectedNodeValues, this.$props.$ext.dataItemProps.idKey);
                selectedNodeValues = utils.CommonsUtils.orderBy(selectedNodeValues, this.$props.$ext.dataItemProps.idKey, 'asc');
                if (this.$props && this.$props.$id) {
                    utils.StatesUtils.update(this.$props.$id, {
         ...
         */
            function () {
                ...
                this.data$.value.forEach(function (node) {
                    utils.TreeUtils.expandNode(node, true, _this.$props.$ext);
                });
            };
        /**
         * @return {?}
         ...
         */
            function () {
                var _this = this;
                this.data$.value.forEach(function (node) {
                    utils.TreeUtils.expandNode(node, false, _this.$props.$ext);
                });
            };
        /**
         * @param {?} event
         ...
         */
            function (filterValue) {
                ...
                if (!filterValue) {
                    ...
                    return utils.TreeUtils.filter(this.unFilteredValue, function (node) {
                        /** @type {?} */
                        var py = node['$py'];
                        if (!py) {
                            py = utils.PinyinUtil.getFirstLetter(node.label);
                            node['$py'] = py;
                        }
                        /** @type {?} */
                        ...
                        if (/^\w+$/.test(filterValue)) {
                            ...
                            return utils.RegUtils.test(sVal, filterValue) || utils.RegUtils.test(py, filterValue);
                        }
                    });
                }
            };
         ...
         */
            function (node) {
                ...
                return utils.CommonsUtils.flattenDeep(value);
            };
        /**
         * @param {?} event
         * @return {?}
         ...
         */
            function (event) {
                ...
                if (treeNodes.length > 0) {
                    ...
                    utils.TreeUtils.expandNode(treeNodes[0], true, this.$props.$ext, level, 1, nodeId);
                }
                ...
                if (this.$props.$ext.filter) {
                    ...
                    if (utils.CommonsUtils.isString(filter)) {
         ...
         */
            function (treeNodes) {
                ...
                if (this.selectedNodeValues && treeNodes) {
                    this._selection = [];
                    /** @type {?} */
                    var values = utils.CommonsUtils.getArrayValue(this.selectedNodeValues);
                    for (var i = 0; i < values.length; i++) {
                        /** @type {?} */
                        var found = utils.TreeUtils.findNode(treeNodes, values[i], this.$props.$ext);
                        if (found) {
         ...
         */
            function (node, nodes) {
                if (utils.CommonsUtils.isEmpty(node)) {
                    return undefined;
                }
                if (node['isVirtual']) {
                    return undefined;
                ...
                if (utils.CommonsUtils.isEmpty(data)) {
                    return undefined;
                }
                /** @type {?} */
                var val;
                if (this.$props.$ext.dataItemProps && this.$props.$ext.dataItemProps.valueKey) {
                    val = utils.DataItemUtils.getItemValue(data, this.$props.$ext.dataItemProps.valueKey);
                }
                else {
                    val = {};
         ...
         */
            function (nodes) {
                ...
                if (this.$props.$ext.nodesFormat === 'plainArray') {
                    treeNodes = utils.TreeUtils.transNodes(treeNodes, {
                        src: this.$props.$ext.dataItemProps,
                        node: PNG_TREE_NODE_KEYS
                    }, this.$props.$ext.root, this.$props.$ext.lazy);
                }
                if (treeNodes[0]) {
                    utils.TreeUtils.initNode(treeNodes[0], this.$props.$ext);
                }
                /** @type {?} */
                var rootNode = {};
                if (this.$props.$ext.virtualRoot) {
                    if (utils.CommonsUtils.isString(this.$props.$ext.virtualRoot)) {
         ...
         */
            function (node) {
                var _this = this;
                if (node) {
                    utils.TreeUtils.initNode(node, this.$props.$ext);
                    if (node.children) {
                        node.children.forEach(function (child) { return utils.TreeUtils.initNode(child, _this.$props.$ext); });
                    }
                }
            };
        PngTreeComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngTreeComponent; }),
                                multi: true
                            }],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
        ...
        /** @nocollapse */
        PngTreeComponent.ctorParameters = function () {
            return [
                { type: core.ChangeDetectorRef }
            ];
        };
        PngTreeComponent.propDecorators = {
            tree: [{ type: core.ViewChild, args: ['pngTree',] }],
            onEmptyNode: [{ type: core.Output }],
    ...
    var PngTreeNavTableComponent = /** @class */ (function (_super) {
        ...
        function PngTreeNavTableComponent(cd, router$$1, activatedRoute) {
            var _this = _super.call(this) || this;
            _this.cd = cd;
            _this.router = router$$1;
            _this.activatedRoute = activatedRoute;
         ...
         */
            function (props) {
                ...
                this.hideTree = false;
                if (props.caption) {
                    utils.CommonsUtils.set(props, 'table.caption', props.caption);
                }
                return props;
            };
        /**
         ...
         */
            function () {
                if (!this.tree) {
                    ...
                    this.hideTree = false;
                    this.switchable = true;
                    this.tree.$id = utils.IdUtils.getRandom();
                    this.tree.$container = this;
                    utils.CommonsUtils.set(this.tree, '$ext.$container', this);
                }
                if (this.table) {
                    this.table.$id = utils.IdUtils.getRandom();
                    this.table.$container = this;
                    utils.CommonsUtils.set(this.table, '$ext.$container', this);
                }
            };
        /**
         * @return {?}
        ...
        PngTreeNavTableComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        animations: [
                            presets.ANIMATIONS.zoomIn,
                            presets.ANIMATIONS.fadeIn
                        ],
                        changeDetection: core.ChangeDetectionStrategy.OnPush
                    }] }
        ];
        /** @nocollapse */
        PngTreeNavTableComponent.ctorParameters = function () {
            return [
                { type: core.ChangeDetectorRef },
                { type: router.Router },
                { type: router.ActivatedRoute }
        ...
        PngTreeNavTableComponent.propDecorators = {
            ...
            switchable: [{ type: core.Input }],
            hideTree: [{ type: core.Input }],
            pngTable: [{ type: core.ViewChild, args: [PngTableComponent,] }],
            pngTree: [{ type: core.ViewChild, args: [PngTreeComponent,] }]
        };
    ...
    var PngWizardComponent = /** @class */ (function (_super) {
        ...
        PngWizardComponent.propDecorators = {
            ...
            styleClass: [{ type: core.Input }],
            style: [{ type: core.Input }],
            stepStyleClass: [{ type: core.Input }],
            stepStyle: [{ type: core.Input }],
            stepChange: [{ type: core.Output }],
            steps: [{ type: core.ContentChildren, args: [PngStepComponent,] }]
        };
    ...
    var PngAdminWorkSpaceComponent = /** @class */ (function (_super) {
        ...
        function PngAdminWorkSpaceComponent(renderer, cd) {
            ...
            _this.darkMenu = true;
            _this.onInitMenu = new core.EventEmitter();
         ...
         */
            function () {
                ...
                this.$subscriptions = utils.StatesUtils.observe(types.StateNames.menu, this.rootMenuToggleStateName)
                    .pipe(operators.filter(function (state) { return state !== undefined; }))
                    .subscribe(function () { return _this._toggleMainMenu(); });
                this.appTitle = this.appTitle || utils.ConfigUtils.getConfig().appTitle;
                this.appName = this.appName || utils.ConfigUtils.getConfig().appName;
                this.appLogo = this.appLogo || utils.ConfigUtils.getConfig().appLogo;
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                /** @type {?} */
                var menu = utils.StatesUtils.getValue(types.StateNames.rootMenu);
        ...
        /** @nocollapse */
        PngAdminWorkSpaceComponent.ctorParameters = function () {
            return [
                { type: core.Renderer2 },
                { type: core.ChangeDetectorRef }
            ];
        ...
        PngAdminWorkSpaceComponent.propDecorators = {
            menuOrientation: [{ type: core.Input }],
            darkMenu: [{ type: core.Input }],
            appName: [{ type: core.Input }],
            appTitle: [{ type: core.Input }],
            appLogo: [{ type: core.Input }],
            httpMenuTag: [{ type: core.Input }],
            onInitMenu: [{ type: core.Output }],
            layoutMenuScrollerViewChild: [{ type: core.ViewChild, args: ['layoutMenuScroller',] }]
        };
        ...
        PrimeNgComponentsModule.decorators = [
            { type: core.NgModule, args: [{
                        exports: [
                            ...
                            primeng.OrganizationChartModule,
                            primeng.PanelModule,
    ...
    var PngTableBodyCellComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PngTableBodyCellComponent.ctorParameters = function () {
            return [
    ...
    var PngTableBodyCellContentComponent = /** @class */ (function (_super) {
        ...
        function PngTableBodyCellContentComponent(pngTable, cell) {
            ...
            _this.pngTable = pngTable;
            _this.cell = cell;
            _this.DATA_ATTR = types.DataAttr;
            _this.DATA_TYPE = types.DataType;
            _this.OVERLAY_TYPE = types.OverlayType;
            return _this;
        }
        Object.defineProperty(PngTableBodyCellContentComponent.prototype, "cellContent", {
             ...
             */ function () {
                var _this = this;
                if (this.column.dataAttr === types.DataAttr.BUTTONS) {
                    /** @type {?} */
                    var btns = this.column.cellContent;
                    btns = utils.CommonsUtils.getArrayValue(btns);
                    btns = btns.filter(function (btn) { return !btn.show || btn.show === true || btn.show.method === true || (utils.CommonsUtils.isFunction(btn.show.method) && ( /** @type {?} */((btn.show.method).call(_this, _this.cellContext())))); });
                    return btns;
                }
                /** @type {?} */
                var content = this.getValue(this.column.cellContent || this.row[this.column.key]);
                if (utils.CommonsUtils.isEmpty(content) && this.column.defaultCellContent !== undefined) {
                    content = this.column.defaultCellContent;
                }
                if (this.column.contentKey) {
                    content = utils.CommonsUtils.get(content, this.column.contentKey);
                    if (utils.CommonsUtils.isArray(content)) {
                        content = ( /** @type {?} */(content.join(',')));
                    }
                }
                else if (this.column.format) {
                    utils.CommonsUtils.format(content, this.column.format);
                }
                else if (utils.CommonsUtils.isFunction(this.column.formatter)) {
                    content = (( /** @type {?} */(this.column.formatter)))(content);
                }
                else if (this.column.formatter || utils.CommonsUtils.isTemplateStr(content)) {
                    content = utils.CommonsUtils.templateStr((( /** @type {?} */(this.column.formatter))) || content, this.row);
                }
                else if (utils.CommonsUtils.isJson(content)) {
                    content = core$1.DataFieldUtils.getFieldDisplayContent(content, this.column.dataField);
                }
                if (utils.CommonsUtils.isString(content) && this.column.maxLength && content.length > this.column.maxLength) {
        ...
        Object.defineProperty(PngTableBodyCellContentComponent.prototype, "cellClass", {
             ...
             * @return {?}
             */ function () {
                return utils.CommonsUtils.getValue(this.column.cellStyleClass, this.cellContext());
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PngTableBodyCellContentComponent.prototype, "cellStyle", {
             ...
             * @return {?}
             */ function () {
                return utils.CommonsUtils.getValue(this.column.cellStyle, this.cellContext());
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PngTableBodyCellContentComponent.prototype, "routLink", {
             ...
             */ function () {
                ...
                if (utils.CommonsUtils.isString(routerLink)) {
                    routerLink = [routerLink];
                }
                /** @type {?} */
                var routeParams;
                if (this.column.routParam) {
                    if (utils.CommonsUtils.isFunction(this.column.routParam)) {
                        routeParams = (( /** @type {?} */(this.column.routParam))).call(this.pngTable, this.column, this.row) || [];
                    }
                    else if (utils.CommonsUtils.isArray(this.column.routParam)) {
                        routeParams = (( /** @type {?} */(this.column.routParam))).map(function (param) { return _this.row[param]; }) || [];
                    }
                    else if (utils.CommonsUtils.isString(this.column.routParam)) {
        ...
        Object.defineProperty(PngTableBodyCellContentComponent.prototype, "queryParam", {
             ...
             */ function () {
                ...
                if (utils.CommonsUtils.isFunction(this.column.routQueryParams)) {
                    return (( /** @type {?} */(this.column.routQueryParams))).call(this.pngTable, this.column, this.row);
                }
                else if (utils.CommonsUtils.isArray(this.column.routQueryParams)) {
                    /** @type {?} */
                    var params_1 = {};
                    (( /** @type {?} */(this.column.routQueryParams))).map(function (param) { return params_1[param] = _this.row[param]; });
                    return params_1;
                }
                else if (utils.CommonsUtils.isString(this.column.routQueryParams)) {
         ...
         */
            function (attr) {
                return this.column.dataAttr === attr ||
                    (utils.CommonsUtils.isArray(this.column.dataAttr) && (( /** @type {?} */(this.column.dataAttr))).indexOf(attr) >= 0);
            };
        /**
         * @param {?} overlay
         * @param {?} index
         ...
         */
            function (content, event) {
                return __assign({}, this.cellContext(event), { type: types.OverlayType.TREE, content: content });
            };
        /**
         * @param {?=} event
         * @return {?}
         ...
         */
            function () {
                ...
                if (this.column.overlays) {
                    (( /** @type {?} */(this.column.overlays))).filter(function (overlay) { return overlay.type === types.OverlayType.MENU; })
         ...
         */
            function (target) {
                return utils.CommonsUtils.getValue(target, this.cellContext()) || '';
            };
        ...
        /** @nocollapse */
        PngTableBodyCellContentComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent },
        ...
        PngTableBodyCellContentComponent.propDecorators = {
            ...
            row: [{ type: core.Input }],
            rowIndex: [{ type: core.Input }],
            selectors: [{ type: core.ViewChildren, args: [core$1.SelectorDirective,] }]
        };
    ...
    var PngTableBodyRowComponent = /** @class */ (function (_super) {
         ...
         */
            function (col) {
                return utils.CommonsUtils.getValue(col.styleClass, this.colContext(col));
            };
        /**
         * @param {?} col
         * @return {?}
         ...
         */
            function (col) {
                return utils.CommonsUtils.getValue(col.style, this.colContext(col));
            };
        ...
        /** @nocollapse */
        PngTableBodyRowComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent },
                { type: core.ChangeDetectorRef }
            ];
        ...
        PngTableBodyRowComponent.propDecorators = {
            ...
            rowHeaderTpl: [{ type: core.Input }],
            rowFooterTpl: [{ type: core.Input }],
            cellTpl: [{ type: core.Input }],
            dataCellTpl: [{ type: core.Input }],
    ...
    var PngTableCaptionComponent = /** @class */ (function (_super) {
        ...
        function PngTableCaptionComponent(pngTable) {
            var _this = _super.call(this) || this;
            _this.pngTable = pngTable;
            _this.onSimpleSearch = new core.EventEmitter();
            return _this;
        }
        /**
         * @param {?} event
         ...
         */
            function () {
                utils.StatesUtils.update(types.StateNames.popup, ( /** @type {?} */(( /** @type {?} */({
                    header: '查询条件定义',
        ...
        /** @nocollapse */
        PngTableCaptionComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
        PngTableCaptionComponent.propDecorators = {
            caption: [{ type: core.Input }],
            hasAddAction: [{ type: core.Input }],
            hasSearchInput: [{ type: core.Input }],
            hasSearchBox: [{ type: core.Input }],
            addButton: [{ type: core.Input }],
            onSimpleSearch: [{ type: core.Output }],
            searchBuilderPanel: [{ type: core.ViewChild, args: ['searchBuilderPanel',] }]
        };
    ...
    var PngTableColumnSelectorComponent = /** @class */ (function (_super) {
        ...
        function PngTableColumnSelectorComponent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.onColumnsChange = new core.EventEmitter();
            return _this;
        }
        /**
         * @param {?} event
        ...
        PngTableColumnSelectorComponent.propDecorators = {
            columns: [{ type: core.Input }],
            optionColumns: [{ type: core.Input }],
            styleClass: [{ type: core.Input }],
            style: [{ type: core.Input }],
            onColumnsChange: [{ type: core.Output }]
        };
    ...
    var PngTableExpandedRowComponent = /** @class */ (function (_super) {
            ...
            function (changes) {
                if (changes.rowId) {
                    if (this.pngTable.$props.$ext.onExpandRowContent) {
                        ...
                        this.expandContent$ = core$1.ApiUtils.getById(this.pngTable.$props.$ext.apiDataProps.apiEntry, this.rowId, {
                            tag: this.rowId,
         ...
         */
            function (col, rowData) {
                ...
                if (utils.CommonsUtils.isJson(c)) {
                    /** @type {?} */
                    var key = void 0;
                    if (col.dataField) {
                        key = core$1.DataFieldUtils.getDefaultFieldName(col.dataField);
                    }
                    if (key) {
                        return utils.CommonsUtils.get(c, key);
                    }
                    else {
                        /** @type {?} */
                        var trans_1 = {};
                        Object.keys(c).forEach(function (sub) {
                            /** @type {?} */
                            var label = utils.CommonsUtils.get(col, "dataField.fields." + sub + ".label");
                            if (label) {
                                trans_1[label] = c[sub];
                            }
                            else {
                ...
                return utils.CommonsUtils.getText(c);
            };
        ...
        /** @nocollapse */
        PngTableExpandedRowComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
    ...
    var PngTableFooterComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PngTableFooterComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
    ...
    var PngTableHeaderColComponent = /** @class */ (function (_super) {
        ...
        function PngTableHeaderColComponent(pngTable, cd) {
            ...
            _this.cd = cd;
            _this.OVERLAY_TYPE = types.OverlayType;
            _this.onFilterBtnClick = new core.EventEmitter();
            _this.onAggsBtnClick = new core.EventEmitter();
            return _this;
        }
        Object.defineProperty(PngTableHeaderColComponent.prototype, "colClass", {
             ...
             * @return {?}
             */ function () {
                if (utils.CommonsUtils.isFunction(this.column.colClass)) {
        ...
        Object.defineProperty(PngTableHeaderColComponent.prototype, "colStyle", {
             ...
             * @return {?}
             */ function () {
                if (utils.CommonsUtils.isFunction(this.column.colStyle)) {
         ...
         */
            function () {
                ...
                if (this.column.headerOverlays) {
                    (( /** @type {?} */(this.column.headerOverlays))).filter(function (overlay) { return overlay.type === types.OverlayType.MENU; })
                        .forEach(function (overlay) {
                        if (overlay.content['menuItem'].command) {
                            /** @type {?} */
                            var command_1 = overlay.content['menuItem'].command;
         ...
         */
            function (overlay, index, event) {
                return {
                    $event: event,
                    type: overlay.type,
                    content: utils.CommonsUtils.getValue(overlay.content, this.headerContext(event)),
                    context: overlay.context,
                    styleClass: utils.CommonsUtils.getValue(overlay.styleClass, this.headerContext(event)),
                    style: utils.CommonsUtils.getValue(overlay.style, this.headerContext(event)),
                    overlayStyleClass: utils.CommonsUtils.getValue(overlay.overlayStyleClass, this.headerContext(event)),
                    overlayStyle: utils.CommonsUtils.getValue(overlay.overlayStyle, this.headerContext(event)),
        ...
        /** @nocollapse */
        PngTableHeaderColComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent },
                { type: core.ChangeDetectorRef }
            ];
        ...
        PngTableHeaderColComponent.propDecorators = {
            column: [{ type: core.Input }],
            onFilterBtnClick: [{ type: core.Output }],
            onAggsBtnClick: [{ type: core.Output }],
            colClass: [{ type: core.HostBinding, args: ['class',] }],
            width: [{ type: core.HostBinding, args: ['style.width',] }],
            colStyle: [{ type: core.HostBinding, args: ['style',] }]
        };
    ...
    var PngTableHeaderComponent = /** @class */ (function (_super) {
        ...
        function PngTableHeaderComponent(pngTable) {
            var _this = _super.call(this) || this;
            _this.pngTable = pngTable;
            _this.onFiltersSet = new core.EventEmitter();
            _this.onAggKeysSet = new core.EventEmitter();
            return _this;
        }
        /**
         * @param {?} event
         ...
         */
            function (event) {
                ...
                /** @type {?} */
                var type = this.aggColumn.dataType || types.DataType.STRING;
                this.aggMethods = (this.aggColumn.aggProps || []).map(function (aggProp) { return aggProp.method; });
                Object.keys(types.AggMethodsProps).forEach(function (method) {
                    if (!types.AggMethodsProps[method].dataTypes || (types.AggMethodsProps[method].dataTypes && types.AggMethodsProps[method].dataTypes.indexOf(type) >= 0)) {
                        _this.availableAggs.push({
                            label: types.AggMethodsProps[method].label,
                            key: types.AggMethodsProps[method].key
                        });
                    }
                });
        ...
        /** @nocollapse */
        PngTableHeaderComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
        PngTableHeaderComponent.propDecorators = {
            columns: [{ type: core.Input }],
            onFiltersSet: [{ type: core.Output }],
            onAggKeysSet: [{ type: core.Output }],
            filterPanel: [{ type: core.ViewChild, args: ['filterPanel',] }],
            aggPanel: [{ type: core.ViewChild, args: ['aggPanel',] }]
        };
    ...
    var PngTableFieldDataFilterComponent = /** @class */ (function (_super) {
        ...
        function PngTableFieldDataFilterComponent(pngTable) {
            var _this = _super.call(this) || this;
            _this.pngTable = pngTable;
            _this.onFilterChange = new core.EventEmitter();
            return _this;
        }
        Object.defineProperty(PngTableFieldDataFilterComponent.prototype, "column", {
             ...
             */ function (column) {
                if (!this.queryKey && column) {
                    this.queryKey = core$1.DataFieldUtils.getDefaultFieldName(column.dataField) || column.key;
                }
                ...
                if (!this.queryDataAttr && column && column.dataAttr) {
                    this.queryDataAttr = utils.CommonsUtils.getArrayValue(column.dataAttr)[0];
                }
                this._column = column;
            },
            enumerable: true,
        ...
        Object.defineProperty(PngTableFieldDataFilterComponent.prototype, "dataField", {
             ...
             */ function (dataField) {
                if (!this.queryKey && dataField) {
                    this.queryKey = core$1.DataFieldUtils.getDefaultFieldName(dataField);
                }
        ...
        /** @nocollapse */
        PngTableFieldDataFilterComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
        PngTableFieldDataFilterComponent.propDecorators = {
            queryKey: [{ type: core.Input }],
            queryDataType: [{ type: core.Input }],
            queryDataAttr: [{ type: core.Input }],
            queryValue: [{ type: core.Input }],
    ...
    var PngTableQueryBuilderComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                ...
                this.qbConfig.operators = function (field) {
                    return Object.keys(types.EsQueryMethods).map(function (key) {
                        return {
                            label: types.EsQueryMethods[key].label,
                            value: types.EsQueryMethods[key].key
                        };
                    });
                };
            };
        PngTableQueryBuilderComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: core.forwardRef(function () { return PngTableQueryBuilderComponent; }),
                                multi: true
                            }],
                        changeDetection: core.ChangeDetectionStrategy.OnPush
                    }] }
        ...
        /** @nocollapse */
        PngTableQueryBuilderComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
    ...
    var PngQueryInputComponent = /** @class */ (function (_super) {
        ...
        function PngQueryInputComponent(pngTable) {
            ...
            _this.DATA_ATTR = types.DataAttr;
            _this.options = {};
            _this.queryValueChange = new core.EventEmitter();
            _this.isTime = false;
            _this.autoCompleteProps$ = new rxjs.BehaviorSubject(undefined);
            return _this;
        }
            ...
            function () {
                ...
                this.autoProps = ( /** @type {?} */({
                    ...
                    $ext: {
                        ...
                        dataItemProps: {
                            showCounter: true,
                            dropDownOptionKey: utils.DataItemUtils.ITEM_LABEL_KEY,
                            valueKey: utils.DataItemUtils.ITEM_LABEL_KEY
                        }
                    }
                }));
                this.sliderProps = ( /** @type {?} */({
                    ...
                    $ext: {
                        apiDataProps: __assign({}, this.pngTable.getTableQuery(), { aggProps: [
                                { name: 'max', field: this.queryKey, method: types.AggMethods.MAX },
                                { name: 'min', field: this.queryKey, method: types.AggMethods.MIN }
                            ] })
                    }
                }));
                if (this.queryDataType === types.DataType.DATE && this.queryDataAttr) {
                    /** @type {?} */
                    var attrs = utils.CommonsUtils.getArrayValue(this.queryDataAttr);
                    if (attrs.indexOf(types.DataAttr.DATE) >= 0) {
                        this.isTime = false;
                    }
                    if (attrs.indexOf(types.DataAttr.TIME) >= 0) {
                        this.isTime = true;
                    }
                }
            };
        ...
        /** @nocollapse */
        PngQueryInputComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent }
            ];
        };
        PngQueryInputComponent.propDecorators = {
            ...
            queryDataAttr: [{ type: core.Input }],
            options: [{ type: core.Input }],
            autoProps: [{ type: core.Input }],
            sliderProps: [{ type: core.Input }],
            queryValueChange: [{ type: core.Output }],
            queryValue: [{ type: core.Input }]
        };
    ...
    var PngTableSummaryComponent = /** @class */ (function (_super) {
                ...
                if (changes.aggValues) {
                    if (changes.aggValues.currentValue) {
                        ...
                        Object.keys(changes.aggValues.currentValue)
                            ...
                            /** @type {?} */
                            var agg = {};
                            agg['type'] = types.AggMethodsProps[type] && types.AggMethodsProps[type].label;
                            if (utils.CommonsUtils.isArray(_this.aggValues[key])) {
         ...
         */
            function (column) {
                return utils.CommonsUtils.getValue(column.aggCellClass, column);
            };
        /**
         * @param {?} column
         * @return {?}
         ...
         */
            function (column) {
                return utils.CommonsUtils.getValue(column.aggCellStyle, column);
            };
        ...
        /** @nocollapse */
        PngTableSummaryComponent.ctorParameters = function () {
            return [
                { type: PngTableComponent },
                { type: core.ChangeDetectorRef }
            ];
    ...
    var WorkSpaceFooterComponent = /** @class */ (function () {
        ...
        Object.defineProperty(WorkSpaceFooterComponent.prototype, "elapseTime$", {
             ...
             * @return {?}
             */ function () {
                return utils.StatesUtils.observe(types.StateNames.httpTimer)
                    .pipe(operators.distinctUntilChanged(), operators.map(function (v) { return v && v['elapsed']; }));
            },
            enumerable: true,
            configurable: true
        });
        ...
        /** @nocollapse */
        WorkSpaceFooterComponent.ctorParameters = function () {
            return [
    ...
    var WorkSpaceTopBarComponent = /** @class */ (function () {
         ...
         */
            function () {
                utils.StatesUtils.toggle(types.StateNames.menu, this.ws.rootMenuToggleStateName);
                event.preventDefault();
            };
        ...
        /** @nocollapse */
        WorkSpaceTopBarComponent.ctorParameters = function () {
            return [
                { type: PngAdminWorkSpaceComponent }
            ];
        };
    ...
    var WorkSpaceMainMenuComponent = /** @class */ (function () {
         ...
         */
            function () {
                this.menus$ = utils.StatesUtils.observe(types.StateNames.rootMenu)
                    .pipe(operators.map(function (menu) { return (menu && menu.menuItems) || []; }), operators.distinctUntilChanged());
            };
        /**
         * @param {?} theme
         * @return {?}
        ...
        /** @nocollapse */
        WorkSpaceMainMenuComponent.ctorParameters = function () {
            return [
                { type: PngAdminWorkSpaceComponent }
            ];
        };
    ...
    var WorkSpaceSubMenuComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        WorkSpaceSubMenuComponent.ctorParameters = function () {
            return [
                { type: PngAdminWorkSpaceComponent },
    ...
    var WorkSpaceProfileComponent = /** @class */ (function () {
        function WorkSpaceProfileComponent(ws) {
            this.ws = ws;
            this.profileRouter = utils.ConfigUtils.getConfig().auth.profileRouter;
            this.changePwdRouter = utils.ConfigUtils.getConfig().auth.changePwdRouter;
        ...
        Object.defineProperty(WorkSpaceProfileComponent.prototype, "user", {
             ...
             * @return {?}
             */ function () {
                return core$1.AuthUtils.getCurrentUser();
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
            function () {
                core$1.RouteUtils.nav(this.changePwdRouter);
            };
            ...
            { type: core.Component, args: [{
                        ...
                        animations: [
                            animations.trigger('menu', [
                                ...
                                animations.transition('visible => hidden', animations.animate('400ms cubic-bezier(0.86, 0, 0.07, 1)')),
                                animations.transition('hidden => visible', animations.animate('400ms cubic-bezier(0.86, 0, 0.07, 1)'))
                            ])
                        ],
                        changeDetection: core.ChangeDetectionStrategy.OnPush
                    }] }
        ...
        /** @nocollapse */
        WorkSpaceProfileComponent.ctorParameters = function () {
            return [
                { type: PngAdminWorkSpaceComponent }
            ];
        };
    ...
    exports.PngAdminWorkSpaceComponent = PngAdminWorkSpaceComponent;
    exports.PrimeNgComponentsModule = PrimeNgComponentsModule;
    exports.ErPrimeNgModule = ErPrimeNgModule;
    exports.PngAdminWorkSpaceModule = PngAdminWorkSpaceModule;
    exports.PngTableComponent = PngTableComponent;
    exports.PngAutoCompleteComponent = PngAutoCompleteComponent;
    exports.PngConfirmDialogComponent = PngConfirmDialogComponent;
    exports.PngCalendarComponent = PngCalendarComponent;
    exports.PngOverlayPanelComponent = PngOverlayPanelComponent;
    exports.PngPanelComponent = PngPanelComponent;
    exports.PngPopupDialogComponent = PngPopupDialogComponent;
    exports.PngAlertComponent = PngAlertComponent;
    exports.PngAnnounceComponent = PngAnnounceComponent;
    exports.PngInputComponent = PngInputComponent;
    exports.PngOptionItemComponent = PngOptionItemComponent;
    exports.PngSearchBoxComponent = PngSearchBoxComponent;
    exports.ValidateMessageTooltipComponent = ValidateMessageTooltipComponent;
    exports.PngSliderComponent = PngSliderComponent;
    exports.PngTreeNavTableComponent = PngTreeNavTableComponent;
    exports.PngButtonComponent = PngButtonComponent;
    exports.PngButtonsComponent = PngButtonsComponent;
    exports.PngCheckBoxComponent = PngCheckBoxComponent;
    exports.PngImageComponent = PngImageComponent;
    exports.PngSelectComponent = PngSelectComponent;
    exports.PngMultiSelectComponent = PngMultiSelectComponent;
    exports.PngListBoxComponent = PngListBoxComponent;
    exports.PngRadioComponent = PngRadioComponent;
    exports.PngRatingComponent = PngRatingComponent;
    exports.PngTreeComponent = PngTreeComponent;
    exports.PNG_TREE_NODE_KEYS = PNG_TREE_NODE_KEYS;
    exports.PngWizardComponent = PngWizardComponent;
    exports.PngStepComponent = PngStepComponent;
    exports.PngChartComponent = PngChartComponent;
    exports.PngFileUploadComponent = PngFileUploadComponent;
    exports.PngSelectButtonComponent = PngSelectButtonComponent;
    exports.PngComponents = PngComponents;
    exports.defaultPngColumnProps = defaultPngColumnProps;
    exports.defaultPngTableProps = defaultPngTableProps;
    exports.defaultRowIndexColumn = defaultRowIndexColumn;
    exports.defaultOrderedRowIndexColumn = defaultOrderedRowIndexColumn;
    exports.defaultActionColumn = defaultActionColumn;
    exports.defaultAddButton = defaultAddButton;
    exports.defaultViewButton = defaultViewButton;
    exports.defaultEditButton = defaultEditButton;
    exports.defaultDeleteButton = defaultDeleteButton;
    exports.defaultAuditButton = defaultAuditButton;
    exports.defaultDownloadButton = defaultDownloadButton;
    exports.defaultOverlayColumnProps = defaultOverlayColumnProps;
    exports.defaultOverlayTableProps = defaultOverlayTableProps;
    exports.ɵa = PngTableSubComponents;
    exports.ɵg = PngTableBodyCellContentComponent;
    exports.ɵh = PngTableBodyCellComponent;
    exports.ɵf = PngTableBodyRowComponent;
    exports.ɵb = PngTableCaptionComponent;
    exports.ɵl = PngTableColumnSelectorComponent;
    exports.ɵi = PngTableExpandedRowComponent;
    exports.ɵj = PngTableFooterComponent;
    exports.ɵd = PngTableHeaderColComponent;
    exports.ɵc = PngTableHeaderComponent;
    exports.ɵe = PngTableFieldDataFilterComponent;
    exports.ɵm = PngTableQueryBuilderComponent;
    exports.ɵn = PngQueryInputComponent;
    exports.ɵk = PngTableSummaryComponent;
    exports.ɵo = WorkSpaceFooterComponent;
    exports.ɵs = WorkSpaceTopBarComponent;
    exports.ɵp = WorkSpaceMainMenuComponent;
    exports.ɵq = WorkSpaceSubMenuComponent;
    exports.ɵr = WorkSpaceProfileComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=er-primeng.umd.js.map