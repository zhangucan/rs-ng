(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-permissions'), require('@er/validate'), require('rxjs/internal/BehaviorSubject'), require('rxjs/index'), require('rxjs/internal/Observable'), require('json-formatter-js'), require('@angular/platform-browser'), require('reflect-metadata'), require('rxjs'), require('elastic-builder'), require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('@angular/forms'), require('@angular/router'), require('@er/types'), require('@er/utils'), require('@stomp/ng2-stompjs'), require('ng-dynamic-component'), require('ngx-pipes'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@er/core', ['exports', 'ngx-permissions', '@er/validate', 'rxjs/internal/BehaviorSubject', 'rxjs/index', 'rxjs/internal/Observable', 'json-formatter-js', '@angular/platform-browser', 'reflect-metadata', 'rxjs', 'elastic-builder', '@angular/common', '@angular/common/http', '@angular/core', '@angular/forms', '@angular/router', '@er/types', '@er/utils', '@stomp/ng2-stompjs', 'ng-dynamic-component', 'ngx-pipes', 'rxjs/operators'], factory) :
    (factory((global.er = global.er || {}, global.er.core = {}),global.ngxPermissions,global.validate,global.rxjs['internal/BehaviorSubject'],global.rxjs.index,global.rxjs['internal/Observable'],global.JSONFormatter,global.ng.platformBrowser,null,global.rxjs,global.esb,global.ng.common,global.ng.common.http,global.ng.core,global.ng.forms,global.ng.router,global.types,global.utils,global.ng2Stompjs,global.ngDynamicComponent,global.ngxPipes,global.rxjs.operators));
}(this, (function (exports,ngxPermissions,validate,BehaviorSubject,index,Observable,JSONFormatter,platformBrowser,reflectMetadata,rxjs,esb,common,http,i0,forms,i1,types,utils,ng2Stompjs,ngDynamicComponent,ngxPipes,operators) { 'use strict';
    ...
    ***************************************************************************** */
            ...
            function () {
                ...
                for (var prop in this) {
                    if (this[prop]) {
                        /** @type {?} */
                        var m = this[prop];
                        if (m && m instanceof rxjs.Subscription) {
                            m.unsubscribe();
                        }
                    }
                }
     ...
     */ BaseDirective = /** @class */ (function (_super) {
         ...
         */
            function (eventName, event) {
                ...
                if (!eventEmitter) {
                    eventEmitter = new i0.EventEmitter();
                    this[eventName] = eventEmitter;
                }
                if (eventEmitter instanceof i0.EventEmitter) {
    ...
    var TypedTemplateDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        TypedTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
        TypedTemplateDirective.propDecorators = {
            type: [{ type: i0.Input, args: ['erTypedTemplate',] }]
        };
    ...
    var BaseComponent = /** @class */ (function (_super) {
            ...
            function () {
                ...
                if (this.typedTemplates && this.typedTemplates.length > 0) {
                    this.typedTemplates.forEach(function (item) {
                        if (item.type) {
                            utils.CommonsUtils.set(_this.templates, item.type, item.template);
                        }
                        else {
         ...
         */
            function (name) {
                ...
                if (this.templates[name]) {
                    ...
                    /** @type {?} */
                    var tpls = utils.CommonsUtils.filter(defaultTpls, function (defaultTpl) { return !!defaultTpl; });
                    if (tpls.length > 0) {
                        return tpls[0];
                    }
                }
         ...
         */
            function (templates) {
                return utils.CommonsUtils.isJson(templates);
            };
        ...
        BaseComponent.propDecorators = {
            customerTpl: [{ type: i0.Input }],
            typedTemplates: [{ type: i0.ContentChildren, args: [TypedTemplateDirective,] }]
        };
    ...
    var DiUtils = /** @class */ (function () {
         ...
         */
            function (token) {
                /** @type {?} */
                var cached = utils.CacheUtils.get(cacheKey, token);
                if (!cached) {
                    if (!DiUtils.injector) {
                    ...
                    if (cached) {
                        utils.CacheUtils.put(cacheKey, token, cached);
                    }
                }
                return cached;
            };
         ...
         */
            function () {
                if (!viewContainerRef) {
                    /** @type {?} */
                    var applicationRef = DiUtils.get(i0.ApplicationRef);
                    /** @type {?} */
    ...
    var HttpUtils = /** @class */ (function () {
         ...
         */
            function () {
                if (!HttpUtils._httpClient) {
                    HttpUtils._httpClient = DiUtils.get(http.HttpClient);
                }
         ...
         */
            function () {
                if (HttpUtils._timeout) {
                    HttpUtils._timeout = utils.ConfigUtils.getConfig().httpTimeout || 5000;
                }
         ...
         */
            function (options) {
                ...
                if (utils.CommonsUtils.isString(options)) {
                    httpRequestOptions = utils.CommonsUtils.getObjWhenStr(options, 'uri');
                }
                else {
                    httpRequestOptions = ( /** @type {?} */(options));
                }
                if (httpRequestOptions.stateName) {
                    return utils.StatesUtils.get(httpRequestOptions.stateName);
                }
                ...
                if (!url.startsWith('http') && url.indexOf('assets/') < 0) {
                    ...
                    url = utils.ConfigUtils.getConfig().api.servers[httpRequestOptions.serverType || utils.ConfigUtils.getConfig().api.default].uri + url;
                }
                /** @type {?} */
                var requestOptions = {};
                requestOptions.observe = httpRequestOptions.observe || 'body';
                requestOptions.responseType = httpRequestOptions.responseType || types.HttpResponseType.JSON;
                requestOptions.headers = HttpUtils.getRequestHeader(httpRequestOptions);
                /** @type {?} */
                var method = httpRequestOptions.method || ((httpRequestOptions.body || httpRequestOptions.payload) ? types.HttpMethod.POST : types.HttpMethod.GET);
                if (httpRequestOptions.payload) {
                    if (httpRequestOptions.payloadType === types.HttpRequestPayloadType.PARAMS) {
                        httpRequestOptions.params = httpRequestOptions.payload;
                    }
                    else if (httpRequestOptions.payloadType === types.HttpRequestPayloadType.BODY) {
                        httpRequestOptions.body = httpRequestOptions.payload;
                    }
                    else if (!method || httpRequestOptions.method === types.HttpMethod.GET) {
                        httpRequestOptions.params = httpRequestOptions.payload;
                    }
                    else {
                        httpRequestOptions.body = httpRequestOptions.payload;
                ...
                return HttpUtils.getHttpClient().request(method, url, __assign({}, requestOptions, { observe: 'events' }))
                    .pipe(utils.RxUtils.retry(httpRequestOptions.retry, HttpUtils.timeout()), operators.filter(function (event) { return event.type === http.HttpEventType.Sent || event.type === http.HttpEventType.Response; }), operators.tap(function (event) {
                    if (event.type === http.HttpEventType.Sent) {
                        HttpUtils.updateHttpTagState(httpRequestOptions.tag, true, { url: url, opts: httpRequestOptions });
                    }
                }), operators.filter(function (event) { return event.type === http.HttpEventType.Response; }), operators.map(function (event) {
                    /** @type {?} */
                    var response = event;
                    ...
                    var resp = httpRequestOptions.onResponse
                        ...
                        : response;
                    if (httpRequestOptions.stateName) {
                        utils.StatesUtils.update(httpRequestOptions.stateName, resp);
                    }
                    return resp;
                    ...
                    return rxjs.of('服务器请求失败，状态码:' + error.status);
                }));
            };
        /**
         * @private
         ...
         */
            function (tag, state, extra) {
                if (tag) {
                    utils.StatesUtils.create([types.StateNames.http, tag], __assign({ start: state }, extra));
                }
            };
        /**
         * @private
         ...
         */
            function (options) {
                ...
                if (typeof options.params === 'string') {
                    params = new http.HttpParams({ fromString: options.params });
                }
                else {
                    ...
                    for (var key in options.params) {
                        if (key) {
                            if (options.params.hasOwnProperty(key) && (options.params[key] !== null || options.params[key] !== undefined)) {
                                params = params.append(key, utils.CommonsUtils.toString(options.params[key]));
                            }
                        }
                    }
                }
         ...
         */
            function (options) {
                ...
                if (options.contentType) {
                    ...
                    headers = headers.append('Content-Type', types.HttpContentType.JSON);
                }
                if (options.headers) {
         ...
         */
            function (file) {
                ...
                /** @type {?} */
                var req = new http.HttpRequest('POST', "upload", formdata, {
                    reportProgress: true,
                    responseType: 'text'
                });
    ...
    var LogService = /** @class */ (function () {
         ...
         */
            function (from, message) {
                ...
                if (!utils.ConfigUtils.getConfig().isProduction
                    && utils.ConfigUtils.getConfig().log.enableApp
                    && utils.ConfigUtils.getConfig().log.level <= types.LogLevel.DEBUG) {
                    if ((typeof from) !== 'string' && from.constructor) {
                        from = from.constructor.name;
                    }
                    if (utils.ConfigUtils.getConfig().log.blackLList.indexOf(from) < 0) {
                        this.getLogger().log("[" + utils.DateUtils.getFormattedTime() + "] %c DEBUG ", 'color: white; background: green; font-size: 18px;', this.getLogData(__spread([from, message], context)));
                    }
                }
            };
        /**
         ...
         */
            function (from, message) {
                ...
                if (utils.ConfigUtils.getConfig().log.level <= types.LogLevel.INFO) {
                    if (typeof from !== 'string' && from.constructor) {
                        from = from.constructor.name;
                    }
                    if (utils.ConfigUtils.getConfig().log.blackLList.indexOf(from) < 0) {
                        this.getLogger().log("[" + utils.DateUtils.getFormattedTime() + "] %c INFO ", 'color: white; background: blue; font-size: 18px;', this.getLogData(__spread([from, message], context)));
                    }
                }
            };
        /**
         ...
         */
            function (messages) {
                if (utils.ConfigUtils.getConfig().log.level <= types.LogLevel.WARN) {
                    this.getLogger().log("[" + utils.DateUtils.getFormattedTime() + "] %c WARN ", 'color: white; background: blue; font-size: 18px;', this.getLogData(messages));
                }
            };
        /**
         * @param {?} from
         ...
         */
            function (from, message) {
                ...
                utils.DialogUtils.error('错误', message);
                if (utils.ConfigUtils.getConfig().log.level <= types.LogLevel.ERROR) {
                    this.getLogger().log("[" + utils.DateUtils.getFormattedTime() + "] %c ERROR ", 'color: white; background: red; font-size: 18px;', this.getLogData(__spread([from, message], context)));
                    if (utils.ConfigUtils.getConfig().log.httpPost) {
                        if (utils.CommonsUtils.isFunction(from)) {
                            from = from.constructor.name;
                        }
                        this.getHttpLogger().log(utils.DateUtils.getFormattedDateTime(), this.getLogData([from, message]));
                    }
                }
            };
        /**
            ...
            function () {
                return ( /** @type {?} */({
                    log: function (message) {
                        ...
                        HttpUtils.request(__assign({}, utils.ConfigUtils.getConfig().logHttpOptions, { body: __assign({ message: message }, optionalParams) }));
                    }
                }));
            };
        /**
    ...
    var ComponentUtils = /** @class */ (function () {
         ...
         */
            function (compInstance, props) {
                ...
                if (compInstance && utils.CommonsUtils.isJson(props)) {
                    Object.keys(props).forEach(function (key) {
                        if (compInstance[key] instanceof i0.EventEmitter) {
            ...
            function (compInstance, hooks, constructor, destructor) {
                ...
                if (hooks) {
                    ...
                    Object.keys(hooks).forEach(function (eventName) {
                        /** @type {?} */
                        var ngEventName = "ng" + utils.CommonsUtils.capitalize(eventName);
                        if (compInstance["__" + ngEventName] === true) {
                            ...
                            constructor.prototype[ngEventName] = function () {
                                var _a;
                                utils.CommonsUtils.isFunction(original_1) && original_1.apply(compInstance, arguments);
                                /** @type {?} */
                    ...
                    if (Object.keys(originalLifeCycles).length > 0) {
                        ...
                        constructor.prototype[destroyLifeCycle_1] = function () {
                            ...
                            utils.CommonsUtils.isFunction(destructor) && destructor.apply(compInstance);
        ...
        ComponentUtils.bind =
            ...
            function (compInstance, props, unSubscribe) {
                var _loop_1 = function (prop) {
                    ...
                    else if ((compInstance[prop] instanceof i0.EventEmitter)) {
                        (( /** @type {?} */(compInstance[prop])))
                            .pipe(operators.takeUntil(unSubscribe || compInstance['destroyed$']))
                            .subscribe(function (event) {
                            try {
                                if (utils.CommonsUtils.isFunction(compInstance['getEventContext'])) {
    ...
    var RouteUtils = /** @class */ (function () {
         ...
         */
            function () {
                /** @type {?} */
                var route = DiUtils.get(i1.ActivatedRoute);
         ...
         */
            function (outletName, isRelative) {
                ...
                DiUtils.get(i1.Router).navigate([{ outlets: (_a = {}, _a[outletName] = null, _a) }], extra);
            };
        /**
         * @param {?} commands
         ...
         */
            function (commands, paramsOrRelative, extras) {
                if (utils.CommonsUtils.isString(commands)) {
                    commands = [commands];
                }
                if (!extras) {
                    extras = ( /** @type {?} */({}));
                ...
                if (paramsOrRelative && Object.keys(paramsOrRelative).length > 0) {
                    utils.CommonsUtils.set(( /** @type {?} */(extras)), 'queryParams', paramsOrRelative);
                }
                if ((utils.CommonsUtils.isString(commands) && !(( /** @type {?} */(commands))).startsWith('/'))
                    || (paramsOrRelative === true)) {
                    utils.CommonsUtils.set(( /** @type {?} */(extras)), 'relativeTo', RouteUtils.getActiveRoute());
                }
                DiUtils.get(i1.Router).navigate(( /** @type {?} */(commands)), extras);
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                DiUtils.get(common.Location).back();
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                DiUtils.get(common.Location).forward();
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                RouteUtils.navigate(utils.StatesUtils.getValue(types.StateNames.nav)['url']);
            };
        /**
         * @param {?} url
         * @return {?}
         ...
         */
            function (url) {
                if (url.startsWith('http')) {
                    ...
                    DiUtils.get(i1.Router).navigateByUrl(url);
                }
            };
        return RouteUtils;
    }());
         ...
         */
            function () {
                ...
                this.$subscriptions = RouteUtils.getActiveRoute().url.subscribe(function (url) {
                    ...
                    /** @type {?} */
                    var data = utils.CommonsUtils.copy(activeRoute.snapshot.data);
                    /** @type {?} */
                    ...
                    /** @type {?} */
                    var props = utils.CommonsUtils.copy(routeData['$resolvedProps'] || routeData['$props']);
                    if (data['$propsKey']) {
                        props = utils.CommonsUtils.get(props, data['$propsKey']);
                    }
                    Object.keys(data).forEach(function (key) {
                        if (utils.CommonsUtils.isFunction(data[key])) {
                            props[key] = (( /** @type {?} */(data[key])))(props, params, data);
                        }
                        else if (utils.CommonsUtils.isString(data[key]) && data[key].startsWith(':')) {
                            /** @type {?} */
    ...
    var ControlComponent = /** @class */ (function (_super) {
        ...
        function ControlComponent() {
            ...
            _this.disabled$ = new rxjs.BehaviorSubject(false);
            _this.onTouched = types.NO_OP;
            _this.onChange = types.NO_OP;
            return _this;
        }
        ...
        ControlComponent.propDecorators = {
            ...
            cursor: [{ type: i0.HostBinding, args: ['style.cursor',] }]
        };
    ...
    var WrapperComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                this.$props = utils.CommonsUtils.defaults({}, this.$props || {}, this.$defaultProps || {});
                if (!this.$props.$id) {
                    this.$props.$id = utils.IdUtils.getRandom();
                }
                if (!this.$props.$ext) {
                    this.$props.$ext = {};
                }
                if (this.$props.$ext['apiDataProps']) {
                    ...
                    utils.CommonsUtils.defaults(this.$props.$ext['apiDataProps'].requestOptions, {
                        context: this,
                        tag: this.$props.$id
                    });
                }
    ...
    var ControlWrapperComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ControlWrapperComponent.prototype, "value", {
             ...
             */ function (value) {
                ...
                if (!utils.CommonsUtils.isEqual(v, this.innerValue)) {
                    this.innerValue = v;
                    this.onChange(v);
                }
            },
        ...
        ControlWrapperComponent.propDecorators = {
            valueParser: [{ type: i0.Input }],
            modelFormatter: [{ type: i0.Input }],
    ...
    var ApiUtils = /** @class */ (function () {
         ...
         */
            function (serverType) {
                if (!serverType) {
                    serverType = utils.CommonsUtils.get(utils.ConfigUtils.getConfig(), 'api.default') || types.ApiServerType.ES;
                }
                ApiUtils.presetApiOptions[serverType] = __assign({}, DEFAULT_API_REQUEST_OPTIONS, utils.CommonsUtils.get(utils.ConfigUtils.getConfig(), "api.servers." + serverType, {}));
         ...
         */
            function (apiEntry, id, options) {
                ...
                /** @type {?} */
                var obv = utils.DialogUtils.confirm('操作确认', '确认执行<b>删除</b>操作吗?')
                    .pipe(operators.first(), operators.filter(function (accept) { return accept; }), operators.switchMap(function (_) {
                    /** @type {?} */
         ...
         */
            function (dataSource, tag) {
                if (dataSource) {
                    ...
                    _apiDataProp = utils.CommonsUtils.copy(_apiDataProp);
                    /** @type {?} */
                    var apiDataProps_1 = utils.CommonsUtils.getArrayValue(_apiDataProp);
                    if (utils.CommonsUtils.isEmpty(apiDataProps_1)) {
                        return;
                    }
                    if (!tag) {
                    ...
                    apiDataProps_1.forEach(function (apiDataProp) {
                        if (dataSource['query']) {
                            ...
                            /** @type {?} */
                            var apiQuery = utils.CommonsUtils.getArrayValue(apiDataProp.query || []);
                            apiQuery.concat(utils.CommonsUtils.getArrayValue(query));
                            apiDataProp.query = apiQuery;
                        }
                        /** @type {?} */
                        var _filter = apiDataProp.filter;
                        if (utils.CommonsUtils.isFunction(_filter)) {
                        ...
                        if (dataSource['interval']) {
                            utils.CommonsUtils.set(( /** @type {?} */(apiDataProp)), 'aggProps.interval', dataSource['interval']);
                        }
                        if (dataSource['format']) {
                            utils.CommonsUtils.set(( /** @type {?} */(apiDataProp)), 'aggProps.format', dataSource['format']);
                        }
                    });
                    ...
                    //   );
                    return rxjs.zip.apply(void 0, __spread(apiDataProps_1.map(function (apiDataProp) { return ApiUtils.fetch(apiDataProp, tag); }))).pipe(operators.map(function (dataSet) {
                        /** @type {?} */
                        var resultList;
                        /** @type {?} */
                        var resultMap;
         ...
         */
            function (apiDataProps, tag) {
                ...
                /** @type {?} */
                var queryPayload;
                if (utils.CommonsUtils.isFunction(apiDataProps.payload)) {
                ...
                if (!queryPayload) {
                    /** @type {?} */
                    var qBody = utils.EsUtils.buildQueryBody(apiDataProps);
                    queryPayload = qBody;
                }
                /** @type {?} */
                ...
                return ApiUtils.getByQuery(apiDataProps.apiEntry, queryPayload, options)
                    ...
                    var aggs;
                    if (data && data.aggs) {
                        aggs = utils.EsUtils.resolveAggs(data.aggs);
                        data.aggs = aggs;
                    }
                    if (utils.CommonsUtils.isEmpty(data.items)) {
                        delete data.items;
                    }
                    if (utils.CommonsUtils.isEmpty(data.aggs)) {
                        delete data.aggs;
                    }
                    /** @type {?} */
                    ...
                    return path ? utils.CommonsUtils.get(data, path) : data;
                }));
            };
        /**
         * @private
         ...
         */
            function (apiEntry, payload, presetActionOptions, actionOptions) {
                ...
                return HttpUtils.request(requestOptions)
                    .pipe(operators.filter(function (response) { return !!response; }), operators.map(function (response) {
                    if (response.success === true) {
                        if (apiRequestOptions.alertSuccess) {
                            utils.DialogUtils.info('操作完成', apiRequestOptions.successMessage);
                        }
                        if (apiRequestOptions.notifySuccess) {
                            utils.StatesUtils.create(types.StateNames.notify, {
                                title: '操作完成',
                        ...
                        if (apiRequestOptions.onSuccess) {
                            ...
                            if (apiRequestOptions.dataPath) {
                                return utils.CommonsUtils.get(response.content, apiRequestOptions.dataPath);
                            }
                        ...
                        if (apiRequestOptions.alertFailure) {
                            utils.DialogUtils.error('操作失败', response.message);
                        }
                        if (apiRequestOptions.notifyFailure) {
                            utils.StatesUtils.create(types.StateNames.notify, {
                                level: types.NotifyLevel.ERROR,
         ...
         */
            function (apiEntry, payload, options) {
                /** @type {?} */
                var uri = apiEntry;
                if (utils.CommonsUtils.isTemplateStr(apiEntry)) ;
                if (utils.CommonsUtils.isString(options.uriResolver)) {
                    uri = ( /** @type {?} */(options.uriResolver));
                }
                else if (utils.CommonsUtils.isFunction(options.uriResolver)) {
         ...
         */
            function (apiEntry, payload, options) {
                ...
                if (utils.CommonsUtils.isJson(_payload)) {
                    _payload = utils.CommonsUtils.merge({}, _payload || {}, options.payload || {}, options.body || options.params || {});
                }
                if (options.payloadResolver) {
                    _payload = (( /** @type {?} */(options.payloadResolver))).call(options.context, apiEntry, _payload, options);
                }
                if (utils.CommonsUtils.isString(_payload)) {
                    return _payload;
                }
                else if (utils.CommonsUtils.isString(options.body)) {
                    return options.body;
                }
                else if (utils.CommonsUtils.isEmpty(_payload)) {
                    return undefined;
                }
                _payload = utils.ContextUtils.resolveVariables(_payload);
                ...
                if (utils.CommonsUtils.isEmpty(_payload)) {
                    return undefined;
                }
                return _payload;
            };
         ...
         */
            function (paramsKeys, payload) {
                if (!utils.CommonsUtils.isJson(payload)) {
                    return payload;
                }
                /** @type {?} */
                var resolved = {};
    ...
    var ApiDataDirective = /** @class */ (function (_super) {
        ...
        function ApiDataDirective() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.onDataReady = new i0.EventEmitter();
            return _this;
        }
        /**
         * @param {?} changes
         ...
         */
            function () {
                var _this = this;
                if (utils.CommonsUtils.isEmpty(this.apiDataProps)) {
        ...
        ApiDataDirective.propDecorators = {
            apiDataProps: [{ type: i0.Input, args: ['erApiData',] }],
            onRequestData: [{ type: i0.Output }],
            onDataReady: [{ type: i0.Output }]
        };
    ...
    var DataAwareControlWrapperComponent = /** @class */ (function (_super) {
         ...
         */
            function (value) {
                try {
                    if (value && this.$props.$ext.dataItemProps && !utils.CommonsUtils.isString(value)) {
                        return utils.DataItemUtils.getItemValue(value, this.$props.$ext.dataItemProps.valueKey);
                    }
                    return value;
                }
                catch (e) {
         ...
         */
            function (model) {
                try {
                    if (utils.CommonsUtils.isJson(model) && this.$props.$ext.dataItemProps) {
                        return utils.DataItemUtils.getItemLabel(model, this.$props.$ext.dataItemProps.labelKey);
                    }
                    return model;
                }
                catch (e) {
        ...
        DataAwareControlWrapperComponent.propDecorators = {
            apiData: [{ type: i0.ViewChild, args: [ApiDataDirective,] }],
            apiDataProps: [{ type: i0.Input }]
        };
    ...
    var BaseFormComponent = /** @class */ (function (_super) {
        ...
        function BaseFormComponent(cd) {
            ...
            _this.onSubmitted = new i0.EventEmitter();
            _this.onModel = new i0.EventEmitter();
            _this.onFormValueChanges = new i0.EventEmitter();
        ...
        Object.defineProperty(BaseFormComponent.prototype, "model", {
             ...
             * @return {?}
             */ function (model) {
                this._model = utils.CommonsUtils.omitBy(model, utils.CommonsUtils.lodash().isUndefined);
                this.refresh();
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(BaseFormComponent.prototype, "submitModel", {
             ...
             */ function () {
                ...
                if (this.submitExcludeKeys) {
                    model = utils.CommonsUtils.removeKeys.apply(utils.CommonsUtils, __spread([model], utils.CommonsUtils.getArrayValue(this.submitExcludeKeys)));
                }
         ...
         */
            function (reset) {
                if (this.initModel) {
                    this.model = utils.CommonsUtils.copy(this.initModel);
                }
                else if (utils.CommonsUtils.isJson(reset)) {
         ...
         */
            function () {
                this.initModel = utils.CommonsUtils.copy(this.model);
         ...
         */
            function () {
                var _this = this;
                if (!this.isFormValid) {
                    utils.DialogUtils.error('操作失败', '请填写完整信息后，再执行本操作！');
                    return;
                }
                /** @type {?} */
                var result;
         ...
         */
            function (result) {
                if (result !== false) {
                    if (utils.CommonsUtils.isJson(result) && !utils.CommonsUtils.isEmpty(result)) {
         ...
         */
            function (model) {
                ...
                if (model) {
                    ...
                    /** @type {?} */
                    var keys = utils.CommonsUtils.getArrayValue(this.resetKeys);
        ...
        BaseFormComponent.propDecorators = {
            ...
            apiEntry: [{ type: i0.Input }],
            options: [{ type: i0.Input }],
            submitRootKey: [{ type: i0.Input }],
            submitExcludeKeys: [{ type: i0.Input }],
            resetKeys: [{ type: i0.Input }],
            styleClass: [{ type: i0.Input }],
            style: [{ type: i0.Input }],
            formStyleClass: [{ type: i0.Input }],
            formStyle: [{ type: i0.Input }],
            buttonsStyleClass: [{ type: i0.Input }],
            submitBtnStyleClass: [{ type: i0.Input }],
            resetBtnStyleClass: [{ type: i0.Input }],
            initBtnStyleClass: [{ type: i0.Input }],
            header: [{ type: i0.Input }],
            footer: [{ type: i0.Input }],
            buttons: [{ type: i0.Input }],
            getModelOptions: [{ type: i0.Input }],
            submitOptions: [{ type: i0.Input }],
            beforeSubmit: [{ type: i0.Input }],
            afterSubmit: [{ type: i0.Input }],
            valueChanges: [{ type: i0.Input }],
            resetAfterSubmit: [{ type: i0.Input }],
            onSubmit: [{ type: i0.Output }],
            onSubmitted: [{ type: i0.Output }],
            onModel: [{ type: i0.Output }],
            onFormValueChanges: [{ type: i0.Output }],
            model: [{ type: i0.Input }],
     ...
     */
    /** @type {?} */
    var HTTP_STATE$ = utils.StatesUtils.observe(types.StateNames.rootHttp)
        .pipe(operators.distinctUntilChanged(), operators.map(function (state) { return state && state.inProcess && state.inProcess > 0; }));
    /** @type {?} */
    var HTTP_TAG_STATE$ = function (httpTag) {
        return utils.StatesUtils.observe(types.StateNames.http, httpTag)
            .pipe(operators.distinctUntilChanged(), operators.filter(function (state) { return !!state; }), operators.map(function (state) { return state && state.start; }));
    };
    /** @type {?} */
    var ROUTE_STATE$ = utils.StatesUtils.observe(types.StateNames.nav)
        .pipe(operators.distinctUntilChanged(), operators.filter(function (state) { return !!state; }), operators.map(function (state) { return state && state.start && state.outlet === 'primary'; }));
    /** @type {?} */
    var ROUTE_OUTLET_STATE$ = function (outlet) {
        return utils.StatesUtils.observe(types.StateNames.nav)
            .pipe(operators.distinctUntilChanged(), operators.filter(function (state) { return !!state; }), operators.map(function (state) { return state && state.start && state.outlet === outlet; }));
    };
    /** @type {?} */
    var WEB_SOCKET_STATES = utils.StatesUtils.observe(types.StateNames.socket)
        .pipe(operators.distinctUntilChanged(), operators.filter(function (state) { return !!state; }), operators.map(function (state) { return state.state; }));
    ...
    var PermissionUtils = /** @class */ (function () {
         ...
         */
            function () {
                if (!PermissionUtils._permissionsService) {
                    PermissionUtils._permissionsService = DiUtils.get(ngxPermissions.NgxPermissionsService);
                }
         ...
         */
            function () {
                if (!PermissionUtils._rolesService) {
                    PermissionUtils._rolesService = DiUtils.get(ngxPermissions.NgxRolesService);
                }
         ...
         */
            function (roles) {
                return (utils.ConfigUtils.getConfig().auth.getRolePermissions
                    && utils.ConfigUtils.getConfig().auth.getRolePermissions(roles))
                    || rxjs.of([]);
            };
        /**
         ...
         */
            function (roles) {
                /** @type {?} */
                var _roles = utils.CommonsUtils.getArrayValue(roles);
                if (_roles) {
                    /** @type {?} */
         ...
         */
            function (permissios) {
                /** @type {?} */
                var _permissions = utils.CommonsUtils.getArrayValue(permissios);
                /** @type {?} */
                var userPermissions = PermissionUtils.getPermissionsService().getPermissions();
         ...
         */
            function (permissions) {
                /** @type {?} */
                var _permissions = utils.CommonsUtils.getArrayValue(permissions);
                /** @type {?} */
                var userPermissions = PermissionUtils.getPermissionsService().getPermissions();
    ...
    var AuthUtils = /** @class */ (function () {
         ...
         */
            function (payLoad, isRememberMe) {
                /** @type {?} */
                var login$ = ApiUtils.login(__assign({}, payLoad, { rememberMe: isRememberMe }), __assign({}, utils.ConfigUtils.getConfig().auth.loginApiOptions || {}, { tag: types.StateNames.auth }))
                    .pipe(operators.filter(function (loginUser) { return !!loginUser; }), operators.tap(function (loginUser) {
                    if (loginUser.jwtToken) {
                        if (utils.ConfigUtils.getConfig().auth.getUserInfo) {
                            utils.ConfigUtils.getConfig().auth.getUserInfo(loginUser)
         ...
         */
            function (payLoad) {
                /** @type {?} */
                var reg$ = ApiUtils.register(payLoad, __assign({}, utils.ConfigUtils.getConfig().auth.registerApiOptions || utils.ConfigUtils.getConfig().auth.loginApiOptions, { tag: types.StateNames.auth }));
                return reg$;
            };
        /**
         * @return {?}
         ...
         */
            function () {
                ApiUtils.logout(__assign({}, utils.ConfigUtils.getConfig().auth.logoutApiOptions || utils.ConfigUtils.getConfig().auth.loginApiOptions, { tag: types.StateNames.auth }))
                    ...
                    if (success) {
                        ...
                        PermissionUtils.clearPermission();
                        /** @type {?} */
                        var url = utils.ConfigUtils.getConfig().auth.logoutSuccessRouter;
                        RouteUtils.nav(url);
                    }
                });
            };
         ...
         */
            function (payload) {
                /** @type {?} */
                var pwd$ = ApiUtils.changePwd(payload, __assign({}, utils.ConfigUtils.getConfig().auth.changePwdApiOptions || utils.ConfigUtils.getConfig().auth.loginApiOptions, { tag: types.StateNames.auth }));
                return pwd$;
            };
        /**
         * @return {?}
         ...
         */
            function () {
                ...
                /** @type {?} */
                var storageKey = utils.ConfigUtils.getConfig().auth.storageKey;
                /** @type {?} */
         ...
         */
            function (patch, remeber) {
                if (!utils.CommonsUtils.isEmpty(patch)) {
                    AuthUtils.CURRENT_USER = __assign({}, AuthUtils.CURRENT_USER, patch);
                }
                else {
                    AuthUtils.CURRENT_USER = {};
                }
                utils.StatesUtils.update(types.StateNames.user, AuthUtils.CURRENT_USER);
                /** @type {?} */
                var storageKey = utils.ConfigUtils.getConfig().auth.storageKey;
                sessionStorage.setItem(storageKey, JSON.stringify(AuthUtils.CURRENT_USER));
                if (remeber) {
                    if (!utils.CommonsUtils.isEmpty(AuthUtils.CURRENT_USER)) {
         ...
         */
            function (returnUrl) {
                ...
                if (currentUser.jwtToken && utils.JwtUtils.isValid(currentUser.jwtToken)) {
                    return true;
                }
                else {
                    if (true === utils.StatesUtils.getValue(types.StateNames.auth, 'dialog')) {
                        utils.StatesUtils.update(types.StateNames.popup, {
                            content: utils.ConfigUtils.getConfig().auth.component,
                            header: utils.ConfigUtils.getConfig().auth.title,
                            visible: true,
                            minWidth: 500,
                            minHeight: 300,
                            contentMaxWidth: 500,
                        ...
                        /** @type {?} */
                        var loginRouter = utils.ConfigUtils.getConfig().auth.loginRouter;
                        utils.StatesUtils.update(types.StateNames.auth, { successUrl: returnUrl });
         ...
         */
            function (user, isRememberMe) {
                if (utils.ConfigUtils.getConfig().auth.onLoginSuccess) {
                    utils.ConfigUtils.getConfig().auth.onLoginSuccess(user);
                }
                user.enabled = true;
                AuthUtils.updateUser(user, isRememberMe);
                PermissionUtils.addRoles(user.roles);
                if (utils.ConfigUtils.getConfig().auth.defaultRules) {
                    PermissionUtils.addRoles(utils.ConfigUtils.getConfig().auth.defaultRules);
                }
                PermissionUtils.addPermissions(user.permissions || []);
                /** @type {?} */
                var key = utils.ConfigUtils.getConfig().auth.requiredUserProps;
                if (key) {
                    if (!utils.CommonsUtils.get(user, key)) {
                        RouteUtils.nav(utils.ConfigUtils.getConfig().auth.failedPropsRouter);
                    }
                    else {
                        /** @type {?} */
                        var successUrl = utils.ConfigUtils.getConfig().auth.loginSuccessRouter;
     ...
     */ AppConfigComponent = /** @class */ (function () {
        ...
        Object.defineProperty(AppConfigComponent.prototype, "loadingClass", {
             ...
             * @return {?}
             */ function () {
                return utils.ConfigUtils.getConfig().onLoading;
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
            function () {
                var _this = this;
                /** @type {?} */
                var browserSupport = utils.BrowserOsUtils.checkBrowser();
                this.resolveBrowserSupport(browserSupport);
                utils.ConfigUtils.configApp(this.appConfig());
                setTimeout(function () {
                ...
                if (!utils.CommonsUtils.isEmpty(user)) {
                    PermissionUtils.addPermissions(user.permissions);
                    PermissionUtils.addRoles(user.roles);
                    if (user.roles && utils.ConfigUtils.getConfig().auth.defaultRules) {
                        PermissionUtils.addRoles(utils.ConfigUtils.getConfig().auth.defaultRules);
                    }
                }
            };
     ...
     */ ModuleConfigComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                /** @type {?} */
                var router = DiUtils.get(i1.Router);
                utils.ConfigUtils.configModule(this.moduleConfig() || {}, router.url);
            };
    ...
    var AuthBaseComponent = /** @class */ (function (_super) {
        ...
        function AuthBaseComponent() {
            var _this = _super.call(this) || this;
            _this.userToken = utils.ConfigUtils.getConfig().auth.userTokenKey;
            _this.password = utils.ConfigUtils.getConfig().auth.passwordKey;
            _this.rememberMe = utils.ConfigUtils.getConfig().auth.rememberMeKey;
            _this.appName = utils.ConfigUtils.getConfig().appName;
            _this.stateKey = types.StateNames.auth;
            return _this;
        }
        /**
         * @return {?}
            ...
            function () {
                ...
                AuthUtils.register(this.getSubmitData(this.form.value))
                    ...
                    if (response.success === false) {
                        ...
                        RouteUtils.nav(utils.ConfigUtils.getConfig().auth.loginSuccessRouter);
                    }
                });
            };
        /**
    ...
    var AbstractLoginComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                var _a;
                this.form = DiUtils.get(forms.FormBuilder).group((_a = {},
                    _a[this.userToken] = ['', forms.Validators.required],
                    _a[this.password] = ['', forms.Validators.required],
                    _a[this.rememberMe] = [''],
                    _a));
            };
    ...
    var NgAsyncValidator = function (requestProps, errorKey) {
        ...
        var fn = function (control) {
            ...
            if (requestProps.query && utils.CommonsUtils.isFunction(requestProps.query)) {
                /** @type {?} */
    ...
    var AbstractRegisterComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                var _a;
                this.form = DiUtils.get(forms.FormBuilder).group((_a = {},
                    _a[this.userToken] = new forms.FormControl('', {
                        validators: validate.NgValidators.required,
                        asyncValidators: NgAsyncValidator(this.userExistsApiOptions(), 'duplicated'),
                        updateOn: 'blur'
                    }),
                    _a[this.password] = ['', [validate.NgValidators.required, validate.NgValidators.minLength(6)]],
                    _a.rePassword = ['', [validate.NgValidators.required, validate.NgValidators.minLength(6), validate.NgValidators.equalTo(this.password)]],
                    _a));
            };
        /**
         * @return {?}
    ...
    var AbstractChangePwdComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                var _a;
                this.form = DiUtils.get(forms.FormBuilder).group((_a = {},
                    _a[this.oldPasswordKey] = ['', forms.Validators.required],
                    _a[this.newPasswordKey] = ['', [validate.NgValidators.required, validate.NgValidators.minLength(6)]],
                    _a.reNewPassword = ['', [validate.NgValidators.required, validate.NgValidators.minLength(6), validate.NgValidators.equalTo(this.newPasswordKey)]],
                    _a));
            };
        /**
         * @return {?}
         ...
         */
            function () {
                ...
                data['userPwdSetDate'] = utils.DateUtils.getFormattedDateTime();
                AuthUtils.changePwd(this.getSubmitData(this.form.value))
                    .subscribe(function (response) {
                    if (response.success === true) {
                        RouteUtils.nav(utils.ConfigUtils.getConfig().auth.changePwdSuccessRouter);
                    }
                    else {
    ...
    var AnimateNumberComponent = /** @class */ (function (_super) {
        ...
        function AnimateNumberComponent(cd) {
            ...
            _this.fontSize = '.8em';
            _this.counter$ = new rxjs.Subject();
            _this.$subscriptions = _this.counter$
                .pipe(operators.switchMap(function (endRange) {
                return rxjs.timer(1000, 200)
                    .pipe(operators.mapTo(_this.positiveOrNegative(endRange, _this.currentNumber)), operators.startWith(_this.currentNumber), operators.scan(function (acc, curr) { return acc + curr; }), operators.takeWhile(_this.takeUntil(endRange, _this.currentNumber)));
            }))
        ...
        Object.defineProperty(AnimateNumberComponent.prototype, "end", {
             ...
             */ function (endRange) {
                this._end = endRange;
                this.currentNumber = endRange - utils.CommonsUtils.getRandomNumber(20);
        ...
        /** @nocollapse */
        AnimateNumberComponent.ctorParameters = function () {
            return [
    ...
    var BreadcrumbsComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                var _this = this;
                this.breadcrumbs$ = utils.StatesUtils.observe(types.StateNames.nav)
                    .pipe(operators.filter(function (state) { return state && state.status === 'success'; }), operators.map(function () { return _this.resolveRoute(); }));
            };
        /**
         * @param {?} breadcrumb
         * @return {?}
         ...
         */
            function () {
                ...
                /** @type {?} */
                var menus = utils.StatesUtils.getValue(types.StateNames.rootMenu);
                /** @type {?} */
                var url;
                /** @type {?} */
                var prefix = utils.CommonsUtils.get(utils.ConfigUtils.getConfig(), 'breadcrumb.prefix');
                /** @type {?} */
                var excludes = utils.CommonsUtils.get(utils.ConfigUtils.getConfig(), 'breadcrumb.excludes');
                /** @type {?} */
                var lastLabel = '';
                do {
                    /** @type {?} */
                    ...
                    childrenRoutes.forEach(function (route) {
                        if (route.outlet === _this.outlet) {
                            ...
                            if (!label) {
                                ...
                                if (url && !utils.RegUtils.test(url, excludes)) {
                                    /** @type {?} */
                                    var parts = url.split('/');
                                    /** @type {?} */
                                    var menu = utils.CommonsUtils.deepFind(menus, { routerLink: url }, { routerLink: "/" + url }, { name: parts[parts.length - 1] });
    ...
    var StateButtonComponent = /** @class */ (function (_super) {
        ...
        function StateButtonComponent(cd) {
            ...
            _this.processing$ = new rxjs.Subject();
            return _this;
        }
         ...
         */
            function () {
                var _this = this;
                if (this.stateKey) {
                    this.$subscriptions = utils.StatesUtils.observe(types.StateNames.http, this.stateKey)
                        .pipe(operators.filter(function (state) { return !!state; }), operators.map(function (state) { return state['start']; })).subscribe(function (b) { return _this.processing$.next(b); });
                }
            };
        /**
         * @param {?} event
        ...
        /** @nocollapse */
        StateButtonComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef }
            ];
        };
        StateButtonComponent.propDecorators = {
            ...
            stateKey: [{ type: i0.Input }],
            stateLabel: [{ type: i0.Input }],
            stateHint: [{ type: i0.Input }],
            context: [{ type: i0.Input }],
            onClick: [{ type: i0.Output }],
            onFocus: [{ type: i0.Output }],
            onBlur: [{ type: i0.Output }],
            processing: [{ type: i0.Input }]
        };
    ...
    var DataItemComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(DataItemComponent.prototype, "labels", {
             ...
             */ function () {
                /** @type {?} */
                var _label = utils.DataItemUtils.getItemLabel(this.item, this.labelKeys);
                if (utils.CommonsUtils.isArray(_label)) {
                    return _label;
                }
                else {
                    return [_label];
    ...
    var DynaComponentUtils = /** @class */ (function () {
         ...
         */
            function (hostViewContainerRef, componentType) {
                ...
                /** @type {?} */
                var componentFactory = utils.CacheUtils.get(cacheKey$1, componentType);
                if (!componentFactory) {
                    componentFactory = DynaComponentUtils.getComponentFactoryResolver().resolveComponentFactory(componentType);
                    utils.CacheUtils.put(cacheKey$1, componentType, componentFactory);
                }
         ...
         */
            function (hostViewContainerRef, template) {
                ...
                /** @type {?} */
                var componentFactory = utils.CacheUtils.get(cacheKey$1, template);
                if (!componentFactory) {
                    /** @type {?} */
                    ...
                    utils.CacheUtils.put(cacheKey$1, template, componentFactory);
                }
                return DynaComponentUtils.createComponent(hostViewContainerRef, componentFactory);
            };
        /**
         ...
         */
            function () {
                if (!DynaComponentUtils._componentFactoryResolver) {
                    DynaComponentUtils._componentFactoryResolver = DiUtils.get(i0.ComponentFactoryResolver);
                }
         ...
         */
            function (component) {
                /** @type {?} */
                var ngModule = i0.NgModule({ declarations: [component] })(/** @class */ (function () {
                    function class_1() {
                    }
                    return class_1;
                }()));
                return DiUtils.get(i0.Compiler).compileModuleAndAllComponentsSync(ngModule);
            };
        /**
         * @private
         * @param {?} hostViewContainerRef
    ...
    var DynaCompComponent = /** @class */ (function () {
        function DynaCompComponent(viewContainerRef, el, renderer) {
            ...
            this.onCreated = new i0.EventEmitter();
        }
        /**
         * @param {?} changes
         * @return {?}
         ...
         */
            function () {
                if (this.type) {
                    if (utils.CommonsUtils.isString(this.type)) {
        ...
        /** @nocollapse */
        DynaCompComponent.ctorParameters = function () {
            return [
    ...
    function recordToChange(record, isFirstChange) {
        ...
        return isFirstChange
            ...
            : new i0.SimpleChange(record.previousValue, record.currentValue, false);
    }
    /**
    ...
    var PropsBindDirective = /** @class */ (function (_super) {
         ...
         */
            function (changes) {
                if (this.autoBind) {
                    if (changes.props && !utils.CommonsUtils.isEmpty(this.props)) {
                        this.resolveProps();
         ...
         */
            function () {
                ...
                Object.keys(inputs)
                    .forEach(function (prop) { return (changes[prop] = new i0.SimpleChange(undefined, inputs[prop], true)); });
                return changes;
            };
        /**
         * @private
         ...
         */
            function () {
                var _this = this;
                if (this.hostComponentInst && utils.CommonsUtils.isJson(this.props)) {
                    this.inputs = {};
                    this.outputs = {};
                    if (this.hostComponentInst._initProps) {
                        this.hostComponentInst.$props = utils.CommonsUtils.merge({}, this.props);
                        this.hostComponentInst._initProps();
                        this.props = utils.CommonsUtils.merge({}, this.hostComponentInst.$props);
                    }
                    if (!this.props['$id']) {
                        this.props['$id'] = utils.IdUtils.getRandom();
                    }
                    ...
                    if (this.hostComponentInst instanceof WrapperComponent) {
                        this.props = utils.CommonsUtils.get(this.props, '$ext', {});
                        if (this.props['hooks']) {
                            this.hooks = this.props['hooks'];
                            delete this.props['hooks'];
                        }
                        ...
                        this.props = utils.CommonsUtils.omit(this.props, '$ext');
                    }
                    Object.keys(this.props).forEach(function (key) {
                        if (_this.hostComponentInst[key] instanceof i0.EventEmitter) {
         ...
         */
            function () {
                if (this.hostComponentInst instanceof WrapperComponent) {
                    this.attrs = utils.CommonsUtils.get(this.attrs, '$ext', {});
                }
                else {
                    this.attrs = utils.CommonsUtils.omit(this.attrs, '$ext');
                }
            };
        ...
        /** @nocollapse */
        PropsBindDirective.ctorParameters = function () {
            return [
    ...
    var DynaContentComponent = /** @class */ (function (_super) {
        ...
        function DynaContentComponent(cd) {
            var _this = _super.call(this) || this;
            _this.cd = cd;
            _this.CONTENT_TYPE = types.ContentType;
            _this.parsedContent$ = new BehaviorSubject.BehaviorSubject(undefined);
            return _this;
        }
        /**
         * @param {?} changes
         ...
         */
            function () {
                var _this = this;
                if (utils.CommonsUtils.isJson(this.content)) {
                    ...
                    if (this.content['data']) {
                        this.contentType = types.ContentType.DATA;
                        this.parsedContent = [];
                        Object.keys(this.content['data']).forEach(function (key) {
                            _this.parsedContent.push({
                                key: key,
                                value: utils.CommonsUtils.getText(_this.content['data'][key])
                            });
                        });
                        return;
                    }
                    else if (this.content['type']) {
                        this.contentType = types.ContentType.COMPONENT;
                        ...
                        if (directives) {
                            directives = utils.CommonsUtils.getArrayValue(directives);
                            directives.filter(function (direct) { return !!direct.type; }).forEach(function (direct) {
                                dynaDirectives_1.push(ngDynamicComponent.dynamicDirectiveDef(direct.type, direct.inputs, direct.outputs));
                            });
                        }
                        if (this.dynaComponent.props || this.context) {
                            dynaDirectives_1.push(ngDynamicComponent.dynamicDirectiveDef(PropsBindDirective, Object.assign({}, this.dynaComponent.props || {}, this.context || {})));
                        }
                ...
                if (utils.CommonsUtils.isString(this.parsedContent)) {
                    if (utils.CommonsUtils.isTemplateStr(this.parsedContent)) {
                        this.parsedContent = utils.CommonsUtils.templateStr(this.parsedContent, this.context) || '<span></span>';
                        this.contentType = types.ContentType.TEMPLATE_STR;
                    }
                    else {
                        this.contentType = types.ContentType.STRING;
                    }
                }
                else if (this.parsedContent instanceof i0.TemplateRef) {
                    this.contentType = types.ContentType.TEMPLATE;
                }
                else if (utils.CommonsUtils.isFunction(this.parsedContent)) {
                    this.parsedContextFn = this.parsedContent;
                    /** @type {?} */
                    var rtn = this.parsedContextFn(this.parsedContext);
                    if (rtn instanceof rxjs.Observable) {
                        (( /** @type {?} */(rtn))).subscribe(function (result) { return _this.parsedContent$.next(utils.CommonsUtils.toString(result)); });
                    }
                    else {
                        this.parsedContent$.next(rtn);
                    }
                    this.contentType = types.ContentType.FUNCTION;
                }
            };
        ...
        /** @nocollapse */
        DynaContentComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef }
            ];
        };
    ...
    var LeftRightContainerComponent = /** @class */ (function (_super) {
        ...
        function LeftRightContainerComponent() {
            ...
            _this.onLeftHide = new i0.EventEmitter();
            _this.templateNames = {
                left: 'left',
                right: 'right'
            };
        ...
        LeftRightContainerComponent.propDecorators = {
            leftStyleClass: [{ type: i0.Input }],
            rightStyleClass: [{ type: i0.Input }],
            hideLeft: [{ type: i0.Input }],
            switchable: [{ type: i0.Input }],
            onLeftHide: [{ type: i0.Output }]
        };
    ...
    var QueryBuilderComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(QueryBuilderComponent.prototype, "config", {
             ...
             * @return {?}
             */ function (config) {
                utils.CommonsUtils.defaults(this._config, config, DEFAULT_QUERY_BUILDER_PROPS);
         ...
         */
            function (index$$1) {
                ...
                /** @type {?} */
                var bgColor = Object.keys(types.THEME_COLORS).filter(function (color, i) { return i === index$$1; });
                if (bgColor.length === 0) {
                    bgColor[0] = 'blue';
                }
                return {
                    ...
                    'border-left-color': types.THEME_COLORS[bgColor[0]]
                };
            };
        /**
         * @param {?} field
         ...
         */
            function (field) {
                var _this = this;
                if (utils.CommonsUtils.isFunction(this.config.operators)) {
         ...
         */
            function (field) {
                if (field && field['defaultOperator'] !== undefined) {
                    ...
                    /** @type {?} */
                    var operators$$1 = this.getOperators(field);
        ...
        QueryBuilderComponent.propDecorators = {
            ruleSet: [{ type: i0.Input }],
            index: [{ type: i0.Input }],
            parentRuleSet: [{ type: i0.Input }],
    ...
    var QueryBuilderRuleComponent = /** @class */ (function (_super) {
        ...
        function QueryBuilderRuleComponent(qb) {
            var _this = _super.call(this) || this;
            _this.qb = qb;
            _this.ruleChange = new i0.EventEmitter();
            return _this;
        }
        ...
        /** @nocollapse */
        QueryBuilderRuleComponent.ctorParameters = function () {
            return [
                { type: QueryBuilderComponent }
            ];
        };
        QueryBuilderRuleComponent.propDecorators = {
            ruleIndex: [{ type: i0.Input }],
            ruleChange: [{ type: i0.Output }],
            rule: [{ type: i0.Input }]
        };
    ...
    var RouteDataPropsBindComponent = /** @class */ (function (_super) {
            ...
            function () {
                ...
                this.$subscriptions = RouteUtils.getActiveRoute().data.subscribe(function (data) {
                    ...
                    if (routeData['$propsKey']) {
                        props = utils.CommonsUtils.get(props, routeData['$propsKey']);
                    }
                    /** @type {?} */
                    ...
                    if (!props['inputs'] && !props['outputs']) {
                        props['$props'] = utils.CommonsUtils.copy(props);
                    }
                    _this.cd.detectChanges();
                });
            };
         ...
         */
            function (componentRef) {
                if (!utils.CommonsUtils.isEmpty(this.hooks)) {
                    /** @type {?} */
        ...
        /** @nocollapse */
        RouteDataPropsBindComponent.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef }
            ];
        };
    ...
    var WechatQrCodeComponent = /** @class */ (function () {
        ...
        Object.defineProperty(WechatQrCodeComponent.prototype, "qrCodeUrl", {
             ...
             */ function () {
                /** @type {?} */
                var wechat = utils.ConfigUtils.getConfig().wechat;
                /** @type {?} */
    ...
    var AnimatedIfDirective = /** @class */ (function (_super) {
        ...
        function AnimatedIfDirective(viewContainer, _templateRef) {
            ...
            _this.animatedIfOnShow = new i0.EventEmitter(false);
            _this.animatedIfOnHide = new i0.EventEmitter(false);
            _this.visible = false;
            _this.destroyed$ = new index.Subject();
            return _this;
        }
        ...
        /** @nocollapse */
        AnimatedIfDirective.ctorParameters = function () {
            return [
                { type: i0.ViewContainerRef },
                { type: i0.TemplateRef }
            ];
        ...
        AnimatedIfDirective.propDecorators = {
            animatedIfOnShow: [{ type: i0.Output }],
            animatedIfOnHide: [{ type: i0.Output }],
            erAnimatedIf: [{ type: i0.Input }]
        };
    ...
    var AnimateDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.animation) {
                    ...
                    classes += this._animations[utils.CommonsUtils.getRandomNumber(this._animations.length - 1)];
                }
                utils.DomUtils.addClasses(this.el.nativeElement, classes);
            };
        ...
        AnimateDirective.propDecorators = {
            animation: [{ type: i0.Input, args: ['erAnimate',] }]
        };
    ...
    var DynaTemplateDirective = /** @class */ (function (_super) {
         ...
         */
            function () {
                if (utils.CommonsUtils.isEmptyString(this.template)) {
        ...
        /** @nocollapse */
        DynaTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.ViewContainerRef },
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
        ...
        DynaTemplateDirective.propDecorators = {
            template: [{ type: i0.Input, args: ['erDynaTemplate',] }],
            context: [{ type: i0.Input }]
        };
    ...
    var FocusHighlightDirective = /** @class */ (function (_super) {
        ...
        FocusHighlightDirective.decorators = [
            { type: i0.Directive, args: [{ selector: '[erFocusHighlight]' },] }
        ];
        /** @nocollapse */
        FocusHighlightDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
    ...
    var HighlightDirective = /** @class */ (function (_super) {
        ...
        HighlightDirective.propDecorators = {
            searchTerm: [{ type: i0.Input, args: ['erHighlight',] }],
    ...
    var JsonViewerDirective = /** @class */ (function (_super) {
                ...
                if (changes.model) {
                    ...
                    if (this.model) {
                        Object.keys(this.model).forEach(function (key) {
                            if (_this.model[key] instanceof rxjs.BehaviorSubject) {
                                _this.model[key] = _this.model[key].value;
                            }
                            else if (_this.model[key] instanceof rxjs.Observable) {
        ...
        /** @nocollapse */
        JsonViewerDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.ChangeDetectorRef }
            ];
        ...
        JsonViewerDirective.propDecorators = {
            model: [{ type: i0.Input, args: ['erJsonViewer',] }],
            showCurrent: [{ type: i0.Input, args: ['current',] }],
            openLevel: [{ type: i0.Input }],
            showDiff: [{ type: i0.Input, args: ['diff',] }]
        };
    ...
    var MovableHandleDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        MovableHandleDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        MovableHandleDirective.propDecorators = {
            movableEnabled: [{ type: i0.HostBinding, args: ['class.movable-enabled',] }],
            isMoving: [{ type: i0.HostBinding, args: ['class.movable-moving',] }],
            movableHandle: [{ type: i0.Input }],
            isHandle: [{ type: i0.HostBinding, args: ['class.movable-handle',] }]
        };
    ...
    var MovableDirective = /** @class */ (function () {
        ...
        MovableDirective.propDecorators = {
            movableConstrained: [{ type: i0.Input }],
            movableConstraint: [{ type: i0.Input }],
            isMoving: [{ type: i0.HostBinding, args: ['class.movable-moving',] }],
            isHandle: [{ type: i0.HostBinding, args: ['class.movable-handle',] }],
            positionStyle: [{ type: i0.HostBinding, args: ['style.position',] }],
            positionTop: [{ type: i0.HostBinding, args: ['style.top.px',] }],
            positionLeft: [{ type: i0.HostBinding, args: ['style.left.px',] }],
            isMovable: [{ type: i0.HostBinding, args: ['class.movable',] }],
            allHandles: [{ type: i0.ContentChildren, args: [MovableHandleDirective, { descendants: true },] }],
            _movableEnabled: [{ type: i0.HostBinding, args: ['class.movable-enabled',] }],
            movableEnabled: [{ type: i0.Input }],
            ...
            onMouseMove: [{ type: i0.HostListener, args: ['document:mousemove', ['$event'],] }],
            onTouchStart: [{ type: i0.HostListener, args: ['touchstart', ['$event'],] }],
            onTouchEnd: [{ type: i0.HostListener, args: ['document:touchend', ['$event'],] }],
            onTouchMove: [{ type: i0.HostListener, args: ['document:touchmove', ['$event'],] }]
        };
    ...
    var PositionDirective = /** @class */ (function () {
        ...
        PositionDirective.propDecorators = {
            positionClass: [{ type: i0.Input, args: ['erPosition',] }]
        };
    ...
    var RemoveMeDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        RemoveMeDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
    ...
    var SelectorDirective = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        SelectorDirective.ctorParameters = function () {
            return [
                { type: i0.ViewContainerRef }
            ];
        };
        SelectorDirective.propDecorators = {
            id: [{ type: i0.Input, args: ['erSelector',] }]
        };
         ...
         */
            function () {
                ...
                if (!this.spinnerClass) {
                    this.spinnerClass = utils.ConfigUtils.getConfig().onLoading || 'fa fa-cog fa-spin fa-spin-2x';
                }
                /** @type {?} */
    ...
    var HttpSpinnerDirective = /** @class */ (function (_super) {
         ...
         */
            function () {
                var _this = this;
                this.$subscriptions = utils.StatesUtils.observe(types.StateNames.http, this.spinnerTag)
        ...
        /** @nocollapse */
        HttpSpinnerDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
            ];
        ...
        HttpSpinnerDirective.propDecorators = {
            spinnerTag: [{ type: i0.Input, args: ['erHttpState',] }]
        };
    ...
    var NotifySpinnerDirective = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        NotifySpinnerDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
            ];
        ...
        NotifySpinnerDirective.propDecorators = {
            notifier: [{ type: i0.Input, args: ['notifySpinner',] }]
        };
    ...
    var TagDirective = /** @class */ (function (_super) {
         ...
         */
            function () {
                if (!utils.CommonsUtils.isEmpty(this.color)) {
                    this.render.setStyle(this.el.nativeElement, 'color', this.color);
                }
                if (!utils.CommonsUtils.isEmpty(this.bg)) {
                    this.render.setStyle(this.el.nativeElement, 'background-color', this.bg);
                }
                if (utils.CommonsUtils.isEmpty(this.color) && utils.CommonsUtils.isEmpty(this.bg)) {
                    if (!this.text) {
                        this.text = this.el.nativeElement.innerHTML;
                    }
                    this.render.setStyle(this.el.nativeElement, 'background', utils.ColorUtils.getColor(this.text));
        ...
        /** @nocollapse */
        TagDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
            ];
    ...
    var HttpAppConfiguredInterceptor = /** @class */ (function () {
        function HttpAppConfiguredInterceptor() {
            this.customerInterceptors = utils.ConfigUtils.getConfig().httpInterceptors;
        }
        /**
         * @param {?} req
         * @param {?} next
            ...
            function (req, next) {
                ...
                return next.handle(req)
                    ...
                    if (err instanceof http.HttpErrorResponse) {
                        if (err.status === 401) {
                            RouteUtils.nav(utils.ConfigUtils.getConfig().auth.loginRouter);
                        }
                    ...
                    else if (err instanceof rxjs.TimeoutError) {
                        utils.StatesUtils.create(types.StateNames.notify, {
                            message: '网络访问超时！',
                            level: types.NotifyLevel.ERROR
                        });
    ...
    var HttpJwtAuthInterceptor = /** @class */ (function () {
        function HttpJwtAuthInterceptor() {
            this.headerName = utils.ConfigUtils.getConfig().auth.headerName;
            this.authScheme = utils.ConfigUtils.getConfig().auth.authScheme;
        }
        /**
         * @param {?} req
         * @param {?} next
    ...
    var DateSyncUtils = /** @class */ (function () {
         ...
         */
            function () {
                /** @type {?} */
                var timeServer = utils.ConfigUtils.getConfig().api.servers.timer;
                if (timeServer) {
                    HttpUtils.request({
                        uri: timeServer.uri,
                        observe: 'events'
         ...
         */
            function () {
                DateSyncUtils.interval = setInterval(function () {
                    ...
                    DateSyncUtils.timeServer$.next(d);
                    utils.StatesUtils.create(types.StateNames.serverTime, { date: d }, true);
                }, 1000);
            };
        /**
         * @private
        ...
        DateSyncUtils.timeServer$ = new rxjs.BehaviorSubject(new Date());
    ...
    var HttpLogInterceptor = /** @class */ (function () {
            ...
            function (req, next) {
                ...
                return next.handle(req)
                    ...
                    if (event instanceof http.HttpResponse) {
                        ...
                        utils.StatesUtils.set(types.StateNames.httpTimer, { elapsed: elapsed });
                        /** @type {?} */
        ...
        /** @nocollapse */
        HttpLogInterceptor.ctorParameters = function () {
            return [
                { type: LogService }
            ];
        };
    ...
    var HttpProgressInterceptor = /** @class */ (function () {
         ...
         */
            function (req, next) {
                var _this = this;
                return next
                    .handle(req).pipe(operators.tap(function (event) {
                    if (event.type === http.HttpEventType.Sent) {
                        utils.StatesUtils.update(types.StateNames.rootHttp, { inProcess: ++_this.inProcess, request: req });
                    }
    ...
    var HttpTimeoutInterceptor = /** @class */ (function () {
        function HttpTimeoutInterceptor() {
            this.timeout = utils.ConfigUtils.getConfig().httpTimeout || 5000;
        }
        /**
         * @param {?} req
         * @param {?} next
         ...
         */
            function (req, next) {
                ...
                return next.handle(req)
                    .pipe(operators.timeout(reqTimeout));
            };
    ...
    function esBoundInterceptor(bounds) {
        return function (req) {
            ...
            var must = [];
            /** @type {?} */
            var query = utils.CommonsUtils.get(req, 'body.query');
            if (query) {
                /** @type {?} */
                var bool = utils.CommonsUtils.get(req, 'body.query.bool');
                if (!bool) {
                    must.push(query);
                }
            }
            must = utils.CommonsUtils.get(req, 'body.query.bool.must', must);
            if (!utils.CommonsUtils.isArray(must)) {
                must = [must];
            }
            /** @type {?} */
            var _bounds = bounds;
            if (!utils.CommonsUtils.isArray(bounds)) {
                _bounds = [bounds];
            }
            _bounds.forEach(function (bound) {
                if (must.indexOf(bound) === -1) {
                    ...
                    else if (utils.CommonsUtils.isFunction(bound)) {
                        must.push(bound(req));
                    }
                    else if (utils.CommonsUtils.isJson(bound)) {
                        must.push(bound);
                    }
                }
            });
            utils.CommonsUtils.set(req, 'body.query.bool.must', must);
            console.log(must);
            return req;
        };
    }
    ...
    var CoreInterceptors = [
        { provide: http.HTTP_INTERCEPTORS, useClass: HttpErrorHandlerInterceptor, multi: true },
        { provide: http.HTTP_INTERCEPTORS, useClass: HttpProgressInterceptor, multi: true },
        { provide: http.HTTP_INTERCEPTORS, useClass: HttpLogInterceptor, multi: true },
        { provide: http.HTTP_INTERCEPTORS, useClass: HttpTimeoutInterceptor, multi: true },
        { provide: http.HTTP_INTERCEPTORS, useClass: HttpJwtAuthInterceptor, multi: true },
        { provide: http.HTTP_INTERCEPTORS, useClass: HttpAppConfiguredInterceptor, multi: true }
    ];
    ...
    var DataItemsPipe = /** @class */ (function () {
         ...
         */
            function (items, config) {
                ...
                return utils.DataItemUtils.transItems(items, config || {});
            };
        DataItemsPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erDataItems' },] }
        ];
    ...
    var DefaultPipe = /** @class */ (function () {
        ...
        DefaultPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erDefault' },] }
        ];
        return DefaultPipe;
    }());
    ...
    var EmojifyPipe = /** @class */ (function () {
        ...
        EmojifyPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erEmojify' },] }
        ];
        return EmojifyPipe;
    }());
         ...
         */
            function (arr, criteria, matcher) {
                ...
                return arr.filter(function (value) {
                    if (utils.CommonsUtils.isJson(value)) {
    ...
    var IdCardPipe = /** @class */ (function () {
         ...
         */
            function (idCardNo, attr) {
                /** @type {?} */
                var attrs = utils.IdCardUtils.parse(idCardNo);
    ...
    var JoinPipe = /** @class */ (function () {
         ...
         */
            function (arr, seperator) {
                return utils.CommonsUtils.join(arr, seperator);
            };
        JoinPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'join' },] }
        ];
        return JoinPipe;
    }());
    ...
    var LinkifyPipe = /** @class */ (function () {
         ...
         */
            function (text, pipeEnabled) {
                ...
                if (pipeEnabled && !utils.CommonsUtils.isEmpty(text)) {
    ...
    var NumberToTextPipe = /** @class */ (function () {
        ...
        NumberToTextPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erNumberToText' },] }
        ];
    ...
    var ObservablePipe = /** @class */ (function () {
        ...
        ObservablePipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'observable', pure: false },] }
        ];
    ...
    var OrderByPipe = /** @class */ (function () {
        ...
        OrderByPipe._getDeepValue = /* filter property by string 'parent.child.item.orderKey' */
            ...
            function (obj, propertyPath) {
                ...
                if (pathList.length > 0) {
                    ...
                    var result = '';
                    while (!flag) {
                        result = getDeepValueByPath(obj, pathList[index$$1]);
                        if (result !== undefined) {
                            flag = true;
                        }
                        else {
        ...
        OrderByPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'orderBy', pure: false },] }
        ];
        return OrderByPipe;
    }());
    ...
    var PercentPipe = /** @class */ (function () {
         ...
         */
            function (num) {
                if (num && utils.CommonsUtils.isNumber(num)) {
                    return num * 100 + "%";
                }
                return num;
            };
        PercentPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erPercent' },] }
        ];
        return PercentPipe;
    }());
    ...
    var SafeHtmlPipe = /** @class */ (function () {
        ...
        SafeHtmlPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erSafeHtml' },] }
        ];
        /** @nocollapse */
    ...
    var StylePipe = /** @class */ (function () {
        ...
        StylePipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erStyle' },] }
        ];
        return StylePipe;
    }());
    ...
    var SubPipe = /** @class */ (function () {
         ...
         */
            function (value, start, end) {
                ...
                /** @type {?} */
                var iEnd = end;
                if (utils.CommonsUtils.isString(value)) {
                    if (!iEnd) {
                        iEnd = value.length;
                    }
                    return value.substr(iStart, iEnd) + '...';
                }
                else if (utils.CommonsUtils.isArray(value)) {
                    if (!iEnd) {
                        iEnd = value.length;
                    }
    ...
    var TextPipe = /** @class */ (function () {
         ...
         */
            function (data) {
                return utils.CommonsUtils.getText(data);
            };
        TextPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erText' },] }
        ];
        return TextPipe;
    }());
    ...
    var TrackerPipe = /** @class */ (function () {
         ...
         */
            function (number, offset) {
                ...
                this.currentNumber = number - utils.CommonsUtils.getRandomNumber(offset);
                this.counter$.next(this.currentNumber);
                this.counter$
                    .pipe(operators.switchMap(function (endRange) {
                    return rxjs.timer(1000, 200)
                        .pipe(operators.mapTo(_this.positiveOrNegative(endRange, _this.currentNumber)), operators.startWith(_this.currentNumber), operators.scan(function (acc, curr) { return acc + curr; }), operators.tap(function (n) { return console.log(n); })
        ...
        /** @nocollapse */
        TrackerPipe.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef }
            ];
        };
    ...
    var TreeNodesPipe = /** @class */ (function () {
         ...
         */
            function (items, keyMap) {
                ...
                return utils.TreeUtils.transNodes(items, keyMap);
            };
        TreeNodesPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erTreeNodes' },] }
        ];
         ...
         */
            function (value, args) {
                if (value !== undefined && value !== null) {
                    return utils.CommonsUtils.unique(value, args);
                }
                return value;
            };
    ...
    var UnitNumberPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        UnitNumberPipe.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
    ...
    var UpToNowPipe = /** @class */ (function () {
         ...
         */
            function (value, due) {
                var _this = this;
                /** @type {?} */
                var d = utils.DateUtils.toDate(value);
                if (!d) {
                    return '';
                }
                /** @type {?} */
                var span = utils.DateUtils.getDateByNow(d, due);
                this.removeTimer();
                /** @type {?} */
                var timeToUpdate = (Number.isNaN(span.seconds)) ? 1000 : utils.DateUtils.getUpdateSeconds(span.seconds) * 1000;
        ...
        /** @nocollapse */
        UpToNowPipe.ctorParameters = function () {
            return [
                { type: i0.ChangeDetectorRef },
                { type: i0.NgZone }
            ];
    ...
    var ValuePipe = /** @class */ (function () {
         ...
         */
            function (data, key) {
                if (utils.CommonsUtils.isJson(data)) {
                    if (key) {
                        return utils.CommonsUtils.get(data, key) || '';
                    }
                    else {
                        return utils.CommonsUtils.toString(data);
                    }
                }
                else {
                    return utils.CommonsUtils.toString(data) || '';
        ...
        ValuePipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'erValue' },] }
        ];
        return ValuePipe;
    }());
    ...
    var AuthGuard = /** @class */ (function () {
        ...
        /** @nocollapse */ AuthGuard.ngInjectableDef = i0.defineInjectable({ factory: function AuthGuard_Factory() { return new AuthGuard(); }, token: AuthGuard, providedIn: "root" });
        return AuthGuard;
    }());
    ...
    var DeactivateGuard = /** @class */ (function () {
        ...
        /** @nocollapse */ DeactivateGuard.ngInjectableDef = i0.defineInjectable({ factory: function DeactivateGuard_Factory() { return new DeactivateGuard(); }, token: DeactivateGuard, providedIn: "root" });
    ...
    var GlobalErrorHandler = /** @class */ (function () {
        function GlobalErrorHandler(injector, zone) {
            ...
            this.location = injector.get(common.LocationStrategy);
        }
        /**
         * @param {?} error
         * @return {?}
         ...
         */
            function (error) {
                ...
                /** @type {?} */
                var url = this.location instanceof common.PathLocationStrategy
                    ? this.location.path() : '';
                this.logService.error(this, message, url, utils.DomUtils.resolveUserAgent());
            };
    ...
    var PathPropsDataResolver = /** @class */ (function () {
         ...
         */
            function (route, state) {
                ...
                if (routeData) {
                    if (!utils.CommonsUtils.isEmpty(routeData)) {
                        /** @type {?} */
                        var pathValues = route.url.map(function (seg) { return seg.path; });
                        if (routeData['$props']) {
                            return rxjs.of(utils.CommonsUtils.get(routeData['$props'], pathValues.join('.')));
                        }
                    }
                }
    ...
    var ResourceResolver = /** @class */ (function () {
        ...
        /** @nocollapse */ ResourceResolver.ngInjectableDef = i0.defineInjectable({ factory: function ResourceResolver_Factory() { return new ResourceResolver(); }, token: ResourceResolver, providedIn: "root" });
    ...
    var RouterStateService = /** @class */ (function () {
         ...
         */
            function (event) {
                ...
                if (event instanceof i1.NavigationStart) {
                    utils.StatesUtils.create(types.StateNames.nav, {
                        start: true,
                        url: activeRoute.url,
                ...
                if (event instanceof i1.NavigationEnd) {
                    utils.StatesUtils.update(types.StateNames.nav, {
                        start: false,
                        status: 'success',
                        url: activeRoute.url,
                        outlet: activeRoute.outlet,
                    ...
                    utils.StatesUtils.update(types.StateNames.currentRoute, { activeRoute: activeRoute });
                    /** @type {?} */
                    var title = activeRoute.data && activeRoute.data['title'];
                    if (title) {
                        utils.StatesUtils.update(types.StateNames.appTitle, { title: title });
                    }
                }
                if (event instanceof i1.NavigationCancel) {
                    utils.StatesUtils.update(types.StateNames.nav, {
                        start: false,
                        status: 'cancel',
                        url: activeRoute.url,
                ...
                if (event instanceof i1.NavigationError) {
                    utils.StatesUtils.update(types.StateNames.nav, {
                        start: false,
                        status: 'error',
                        url: activeRoute.url,
        ...
        /** @nocollapse */
        RouterStateService.ctorParameters = function () {
            return [
                { type: i1.Router }
            ];
        };
     ...
     */
    /** @type {?} */
    var BACKGROUND_TASK_TOKEN = new i0.InjectionToken('BACKGROUND_TASK_TOKEN');
    /**
    ...
    var TaskService = /** @class */ (function () {
        function TaskService(tasks) {
            ...
            var _this = this;
            this.subs = [];
            utils.StatesUtils.create(types.StateNames.appTitle, utils.ConfigUtils.getConfig().appTitle, true);
            setTimeout(function () {
                _this.cleanStates();
                /** @type {?} */
                var _tasks = utils.CommonsUtils.flatten(tasks);
         ...
         */
            function () {
                this.subs.push(utils.StatesUtils.observe(types.StateNames.appTitle)
                    .pipe(operators.filter(function (state) { return state && state.hasOwnProperty('title'); }), operators.map(function (state) { return state.title; }), operators.distinctUntilChanged())
                    .subscribe(function (title) {
                    DiUtils.get(platformBrowser.Title).setTitle(title);
                }));
            };
        /**
         * @return {?}
         ...
         */
            function () {
                this.subs.push(rxjs.timer(30000, 30000)
                    .subscribe(function () {
                    /** @type {?} */
                    var store = utils.StatesUtils.getStore().value;
                    Object.keys(store).forEach(function (key) {
                        if (store[key]) {
                            if (!store[key].preserved && (store[key].state && store[key].state.observers.length === 0)) {
                                store = utils.CommonsUtils.omit(store, key);
                            }
                        }
                    });
                    utils.StatesUtils.getStore().next(store);
                }));
            };
        /**
         * @param {?} task
         ...
         */
            function (task) {
                if (utils.CommonsUtils.isFunction(task)) {
                    (( /** @type {?} */(task)))();
                }
                else {
                    /** @type {?} */
                    ...
                    if (utils.CommonsUtils.isFunction(schedule_1.context)) {
                        context_1 = schedule_1.context();
                    }
                    if (schedule_1.interval) {
                        this.subs.push(rxjs.timer(0, schedule_1.interval)
                            .subscribe(function () {
        ...
        TaskService.ctorParameters = function () {
            return [
                { type: Array, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [BACKGROUND_TASK_TOKEN,] }] }
            ];
        };
    ...
    var updateTitleTask = function () {
        utils.StatesUtils.observe(types.StateNames.appTitle)
            .pipe(operators.filter(function (appTitle) { return appTitle && appTitle.hasOwnProperty('title'); }), operators.map(function (appTitle) { return appTitle.title; }), operators.distinctUntilChanged())
            .subscribe(function (title) {
            DiUtils.get(platformBrowser.Title).setTitle(title);
        });
    };
    ...
    var DataUtils = /** @class */ (function () {
         ...
         */
            function (options) {
                var _a;
                /** @type {?} */
                var opt = utils.CommonsUtils.defaults(options || {}, DataUtils.DEFAULT_PROPS);
                /** @type {?} */
                var q = utils.CommonsUtils.getArrayValue(opt.query) || [];
                if (opt.parent) {
                    q.push(esb.termQuery(opt.parentKey, opt.parent));
                }
                return ApiUtils.getByQuery("" + opt.apiEntry, ( /** @type {?} */({
                    query: q,
                    sort: (_a = {}, _a[opt.seqKey] = types.Order.DESC, _a),
                    size: 1
                }))).pipe(operators.map(function (data) {
                    /** @type {?} */
                    ...
                    if (data.total !== 0) {
                        ...
                        if (last[opt.seqKey]) {
                            ...
                            utils.DialogUtils.error('错误', '无法生成新的序列号');
                            rxjs.throwError('无法生成新的序列号');
                        }
                    }
                    /** @type {?} */
         ...
         */
            function (props) {
                /** @type {?} */
                var result$ = ApiUtils.fetch(__assign({}, props.apiProps, { size: 2 })).pipe(operators.map(function (data) {
                    return !data.items || data.items.length === 0 ||
                        (data.items.length === 1 && data.items[0]['id'] === props.id);
                }), operators.tap(function (distinct) {
                    if (!distinct) {
                        utils.DialogUtils.error('验证失败', "\u6570\u503C\u3010" + props.apiProps.queryValue + "\u3011\u5DF2\u7ECF\u5B58\u5728\uFF0C\u8BF7\u4FEE\u6539\u540E\u518D\u6267\u884C\u672C\u64CD\u4F5C\uFF01");
                    }
                }));
                return result$;
            };
         ...
         */
            function (event, keyOrQuery) {
                ...
                /** @type {?} */
                var tableId = utils.CommonsUtils.get(treeProps, '$ext.$container.table.$id');
                if (tableId) {
                    /** @type {?} */
                    var q = keyOrQuery;
                    /** @type {?} */
                    var nodeCode = event.node.data && event.node.data.code;
                    if (nodeCode && utils.CommonsUtils.isString(keyOrQuery)) {
                        q = esb.prefixQuery(keyOrQuery, nodeCode);
                    }
                    utils.StatesUtils.update(tableId, ( /** @type {?} */({
    ...
    var DataFieldUtils = /** @class */ (function () {
         ...
         */
            function (dataField) {
                switch (dataField.dataAttr) {
                    case types.DataAttr.DATA_CODE:
                        return DataFieldUtils.getDataCodeFieldProps(dataField);
                    case types.DataAttr.URL:
                        dataField.dataType = types.DataType.STRING;
                        dataField.pattern = types.RegPatterns.url;
                        break;
                    case types.DataAttr.PHONE:
                        dataField.dataType = types.DataType.STRING;
                        dataField.pattern = types.RegPatterns.phone;
                        break;
                    ...
                    case types.DataAttr.EMAIL:
                        dataField.dataType = types.DataType.STRING;
                        dataField.pattern = types.RegPatterns.email;
                        break;
                    case types.DataAttr.CURRENCY:
                        dataField.defaultValue = 0;
                        dataField.dataType = types.DataType.NUMBER;
                        dataField.pattern = types.RegPatterns.pNumeric;
                        break;
                }
                return dataField;
            };
         ...
         */
            function (fieldValue, field) {
                ...
                if (field) {
                    if (utils.CommonsUtils.isJson(fieldValue)) {
                        /** @type {?} */
                        var key = void 0;
                        if (field) {
                        ...
                        if (key) {
                            return utils.CommonsUtils.get(fieldValue, key);
                        }
                        else {
                            /** @type {?} */
                            var trans_1 = {};
                            Object.keys(fieldValue).forEach(function (sub) {
                                /** @type {?} */
                                var label = utils.CommonsUtils.get(field, "fields." + sub + ".label")
                                    && utils.CommonsUtils.get(field, "refer.entity." + sub + ".label")
                                    && utils.CommonsUtils.get(field, "refer." + sub + ".label");
                                if (label) {
                ...
                if (utils.CommonsUtils.isBoolean(fieldValue)) {
                    return fieldValue ? '是' : '否';
                }
                else {
                    return utils.CommonsUtils.getText(fieldValue);
                }
            };
        /**
         * @private
         ...
         */
            function (dataField) {
                /** @type {?} */
                var props = utils.ConfigUtils.getConfig().dataFieldProps.dataCode;
    ...
    var ChangesUtils = /** @class */ (function () {
         ...
         */
            function (diff) {
                ...
                return utils.CommonsUtils.omitBy(changes, utils.CommonsUtils.lodash().isEmpty);
            };
        return ChangesUtils;
    }());
    ...
    var ResourceUtils = /** @class */ (function () {
         ...
         */
            function (options) {
                ...
                /** @type {?} */
                var resourcesConfig = __assign({}, utils.ConfigUtils.getConfig().resources, options);
                ...
                /** @type {?} */
                var state = utils.StatesUtils.get(path, true);
                if (!state.value || options.reload) {
                    ...
                    return HttpUtils.request({
                        ...
                        tag: path,
                        onResponse: function (response) { return response ? utils.CommonsUtils.restoreJsonFn(response) : null; }
                    }).pipe(operators.take(1), operators.tap(function (response) { return utils.StatesUtils.create(path, response, resourcesConfig.reserve || resourcesConfig.state !== undefined); }));
                }
                else {
                    return state;
                }
    ...
    var UrlUtils = /** @class */ (function () {
        ...
        UrlUtils.serializer = new i1.DefaultUrlSerializer();
        return UrlUtils;
    }());
    ...
    var ErCoreModule = /** @class */ (function () {
        function ErCoreModule(injector) {
            ...
            if (!DiUtils.injector) {
                ...
                try {
                    /** @type {?} */
                    var stompService = injector.get(ng2Stompjs.StompService);
                    if (stompService && utils.ConfigUtils.getConfig().stomp.enabled) {
                        stompService.state
                            .pipe(operators.distinctUntilChanged(), operators.tap(function (state) {
                            utils.StatesUtils.update(types.StateNames.socket, { state: types.StompStates[state] });
                            utils.StatesUtils.update(types.StateNames.notify, {
                                type: state === 0 ? types.NotifyType.ANNOUNCE : types.NotifyType.ALERT,
                                message: "\u6D88\u606F\u670D\u52A1\u5668\u72B6\u6001\uFF1A" + types.StompStates[state],
                                level: state === 0 ? types.NotifyLevel.ERROR : types.NotifyLevel.INFO
                            });
                        })).subscribe();
                    }
                }
            ...
            function (appConfig) {
                return {
                    ...
                    providers: __spread([
                        ...
                        appConfig.stomp.enabled ? ng2Stompjs.StompService : [],
                        appConfig.stomp.enabled ? { provide: ng2Stompjs.StompConfig, useValue: appConfig.stomp } : [],
        ...
        ErCoreModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [
                            ...
                            ngDynamicComponent.DynamicModule.withComponents(CoreComponents)
                        ],
        ...
        /** @nocollapse */
        ErCoreModule.ctorParameters = function () {
            return [
                { type: i0.Injector }
            ];
        };
    ...
    exports.AbstractLoginComponent = AbstractLoginComponent;
    exports.AbstractRegisterComponent = AbstractRegisterComponent;
    exports.AbstractChangePwdComponent = AbstractChangePwdComponent;
    exports.AuthBaseComponent = AuthBaseComponent;
    exports.CoreComponents = CoreComponents;
    exports.BreadcrumbsComponent = BreadcrumbsComponent;
    exports.StateButtonComponent = StateButtonComponent;
    exports.StateButtonsComponent = StateButtonsComponent;
    exports.DynaContentComponent = DynaContentComponent;
    exports.ContainerComponent = ContainerComponent;
    exports.DataItemComponent = DataItemComponent;
    exports.HttpStatusComponent = HttpStatusComponent;
    exports.FluidContainerComponent = FluidContainerComponent;
    exports.LeftRightContainerComponent = LeftRightContainerComponent;
    exports.MobileType = MobileType;
    exports.PhonePreviewComponent = PhonePreviewComponent;
    exports.RouteDataPropsBindComponent = RouteDataPropsBindComponent;
    exports.QueryBuilderComponent = QueryBuilderComponent;
    exports.QueryBuilderRuleComponent = QueryBuilderRuleComponent;
    exports.AnimateNumberComponent = AnimateNumberComponent;
    exports.DynaCompComponent = DynaCompComponent;
    exports.JsonViewerDirective = JsonViewerDirective;
    exports.ObjectDiff = ObjectDiff;
    exports.CoreDirectives = CoreDirectives;
    exports.AnimateDirective = AnimateDirective;
    exports.ApiDataDirective = ApiDataDirective;
    exports.TypedTemplateDirective = TypedTemplateDirective;
    exports.DynaTemplateDirective = DynaTemplateDirective;
    exports.PropsBindDirective = PropsBindDirective;
    exports.TagDirective = TagDirective;
    exports.SelectorDirective = SelectorDirective;
    exports.PositionDirective = PositionDirective;
    exports.RemoveMeDirective = RemoveMeDirective;
    exports.HttpSpinnerDirective = HttpSpinnerDirective;
    exports.NotifySpinnerDirective = NotifySpinnerDirective;
    exports.HighlightDirective = HighlightDirective;
    exports.FocusHighlightDirective = FocusHighlightDirective;
    exports.MovableHandleDirective = MovableHandleDirective;
    exports.Position = Position;
    exports.MovableDirective = MovableDirective;
    exports.HttpAppConfiguredInterceptor = HttpAppConfiguredInterceptor;
    exports.HttpErrorHandlerInterceptor = HttpErrorHandlerInterceptor;
    exports.HttpJwtAuthInterceptor = HttpJwtAuthInterceptor;
    exports.HttpProgressInterceptor = HttpProgressInterceptor;
    exports.HttpLogInterceptor = HttpLogInterceptor;
    exports.HttpTimeoutInterceptor = HttpTimeoutInterceptor;
    exports.CoreInterceptors = CoreInterceptors;
    exports.esBoundInterceptor = esBoundInterceptor;
    exports.credentialHttpRequestInterceptor = credentialHttpRequestInterceptor;
    exports.FilterPipe = FilterPipe;
    exports.HighLightPipe = HighLightPipe;
    exports.KeysPipe = KeysPipe;
    exports.SafeHtmlPipe = SafeHtmlPipe;
    exports.StylePipe = StylePipe;
    exports.KeyValuePipe = KeyValuePipe;
    exports.JoinPipe = JoinPipe;
    exports.ObservablePipe = ObservablePipe;
    exports.OrderByPipe = OrderByPipe;
    exports.IdCardPipe = IdCardPipe;
    exports.SplitPipe = SplitPipe;
    exports.UniquePipe = UniquePipe;
    exports.Base64DecodePipe = Base64DecodePipe;
    exports.CommaSeparatedNumberPipe = CommaSeparatedNumberPipe;
    exports.LinkifyPipe = LinkifyPipe;
    exports.NumberToTextPipe = NumberToTextPipe;
    exports.UnitNumberPipe = UnitNumberPipe;
    exports.DataItemsPipe = DataItemsPipe;
    exports.TreeNodesPipe = TreeNodesPipe;
    exports.PercentPipe = PercentPipe;
    exports.SubPipe = SubPipe;
    exports.TextPipe = TextPipe;
    exports.TimerPipe = TimerPipe;
    exports.UpToNowPipe = UpToNowPipe;
    exports.ValuePipe = ValuePipe;
    exports.DefaultPipe = DefaultPipe;
    exports.TrackerPipe = TrackerPipe;
    exports.EmojifyPipe = EmojifyPipe;
    exports.CorePipes = CorePipes;
    exports.GlobalErrorHandler = GlobalErrorHandler;
    exports.AuthGuard = AuthGuard;
    exports.DeactivateGuard = DeactivateGuard;
    exports.ConfigurablePreloadingStrategy = ConfigurablePreloadingStrategy;
    exports.TaskService = TaskService;
    exports.BACKGROUND_TASK_TOKEN = BACKGROUND_TASK_TOKEN;
    exports.RouterStateService = RouterStateService;
    exports.ResourceResolver = ResourceResolver;
    exports.LogService = LogService;
    exports.PathPropsDataResolver = PathPropsDataResolver;
    exports.CoreServices = CoreServices;
    exports.updateTitleTask = updateTitleTask;
    exports.CORE_TASKS = CORE_TASKS;
    exports.HTTP_STATE$ = HTTP_STATE$;
    exports.HTTP_TAG_STATE$ = HTTP_TAG_STATE$;
    exports.ROUTE_STATE$ = ROUTE_STATE$;
    exports.ROUTE_OUTLET_STATE$ = ROUTE_OUTLET_STATE$;
    exports.WEB_SOCKET_STATES = WEB_SOCKET_STATES;
    exports.AnnotationsUtils = AnnotationsUtils;
    exports.DEFAULT_API_REQUEST_OPTIONS = DEFAULT_API_REQUEST_OPTIONS;
    exports.ApiUtils = ApiUtils;
    exports.anyRoleUser = anyRoleUser;
    exports.AuthUtils = AuthUtils;
    exports.PermissionUtils = PermissionUtils;
    exports.DateSyncUtils = DateSyncUtils;
    exports.DataUtils = DataUtils;
    exports.DataFieldUtils = DataFieldUtils;
    exports.ComponentUtils = ComponentUtils;
    exports.ChangesUtils = ChangesUtils;
    exports.DiUtils = DiUtils;
    exports.LogUtils = LogUtils;
    exports.DynaComponentUtils = DynaComponentUtils;
    exports.HttpUtils = HttpUtils;
    exports.RouteUtils = RouteUtils;
    exports.ResourceUtils = ResourceUtils;
    exports.UrlUtils = UrlUtils;
    exports.NgAsyncValidator = NgAsyncValidator;
    exports.FormlyAsyncValidator = FormlyAsyncValidator;
    exports.ɵb = WechatQrCodeComponent;
    exports.ɵc = AnimatedIfDirective;
    exports.ɵd = SpinnerBaseDirective;
    exports.ɵa = APP_CONFIG;
    exports.ɵe = CachedRouteReuseStrategy;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=er-core.umd.js.map