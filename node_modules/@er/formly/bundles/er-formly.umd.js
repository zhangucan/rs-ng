(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@er/utils'), require('rxjs/operators'), require('@angular/core'), require('@angular/forms'), require('@er/core'), require('@er/validate'), require('@ngx-formly/core'), require('primeng/primeng')) :
    typeof define === 'function' && define.amd ? define('@er/formly', ['exports', 'rxjs', '@er/utils', 'rxjs/operators', '@angular/core', '@angular/forms', '@er/core', '@er/validate', '@ngx-formly/core', 'primeng/primeng'], factory) :
    (factory((global.er = global.er || {}, global.er.formly = {}),global.rxjs,global.utils,global.rxjs.operators,global.ng.core,global.ng.forms,global.core$1,global.validate,global.core$2,global.primeng));
}(this, (function (exports,rxjs,utils,operators,core,forms,core$1,validate,core$2,primeng) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyPropsBindDirective = /** @class */ (function (_super) {
        ...
        FormlyPropsBindDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[formlyPropsBind]' },] }
        ];
        return FormlyPropsBindDirective;
    }(core$1.PropsBindDirective));
         ...
         */
            function () {
                ...
                if (_widgets.length === 1) {
                    component = core$1.ComponentUtils.getHostComponentInst(_widgets[0]);
                }
                else if (_widgets.length > 1) {
                    component = _widgets.map(function (widget) { return core$1.ComponentUtils.getHostComponentInst(widget); });
                }
         ...
         */
            function () {
                ...
                if (this.defaultProps) {
                    this.field['props'] = utils.CommonsUtils.defaults({}, this.field['props'], this.defaultProps);
                }
                this.field['formlyField'] = this;
            };
        ErFormlyFieldType.propDecorators = {
            widgets: [{ type: core.ViewChildren, args: [FormlyPropsBindDirective, { read: core.ViewContainerRef },] }],
            validateMessage: [{ type: core.ViewChild, args: [validate.ValidationMessageDirective,] }]
        };
    ...
    var FormlyFormComponent = /** @class */ (function (_super) {
        ...
        function FormlyFormComponent(cd) {
            ...
            _this.cd = cd;
            _this.options = {};
            _this.valueChanges$ = new rxjs.Subject();
            return _this;
        }
        ...
        /** @nocollapse */
        FormlyFormComponent.ctorParameters = function () {
            return [
    ...
    var FORMLY_VALIDATORS = [
        ...
        { name: 'letter', validation: validate.NgValidators.letter },
        { name: 'digit', validation: validate.NgValidators.digit },
        { name: 'character', validation: validate.NgValidators.character },
        { name: 'chinese', validation: validate.NgValidators.chinese },
        { name: 'integer', validation: validate.NgValidators.integer },
        { name: 'numeric', validation: validate.NgValidators.numeric },
        { name: 'full', validation: validate.NgValidators.fullWidth },
        { name: 'half', validation: validate.NgValidators.halfWidth },
        { name: 'phone', validation: validate.NgValidators.phone },
        { name: 'idCard', validation: validate.NgValidators.idCard },
        { name: 'match', validation: validate.NgValidators.match },
        { name: 'required', validation: validate.NgValidators.required },
        { name: 'accept', validation: validate.NgValidators.accept },
        { name: 'email', validation: validate.NgValidators.email },
        { name: 'url', validation: validate.NgValidators.url },
        { name: 'date', validation: validate.NgValidators.date },
        { name: 'json', validation: validate.NgValidators.json },
        { name: 'base64', validation: validate.NgValidators.base64 },
        { name: 'creditCard', validation: validate.NgValidators.creditCard },
        { name: 'password', validation: validate.NgValidators.password },
        { name: 'after', validation: validate.NgValidators.after },
        { name: 'before', validation: validate.NgValidators.before },
        { name: 'between', validation: validate.NgValidators.between },
        { name: 'dateFormat', validation: validate.NgValidators.dateFormat },
        { name: 'age', validation: validate.NgValidators.age },
        { name: 'equalTo', validation: validate.NgValidators.equalTo },
        { name: 'notEqualTo', validation: validate.NgValidators.notEqualTo },
        { name: 'minLength', validation: validate.NgValidators.minLength },
        { name: 'maxLength', validation: validate.NgValidators.maxLength },
        { name: 'min', validation: validate.NgValidators.min },
        { name: 'max', validation: validate.NgValidators.max },
        { name: 'pattern', validation: validate.NgValidators.pattern },
        { name: 'rangeLength', validation: validate.NgValidators.rangeLength },
        { name: 'range', validation: validate.NgValidators.range },
        { name: 'gt', validation: validate.NgValidators.gt },
        { name: 'gte', validation: validate.NgValidators.gte },
        { name: 'lt', validation: validate.NgValidators.lt },
        { name: 'lte', validation: validate.NgValidators.lte },
        { name: 'minDate', validation: validate.NgValidators.minDate },
        { name: 'maxDate', validation: validate.NgValidators.maxDate },
        { name: 'equal', validation: validate.NgValidators.equal },
        { name: 'notEqual', validation: validate.NgValidators.notEqual },
        { name: 'equalTo2', validation: validate.NgValidators.equalTo2 },
        { name: 'notEqualTo2', validation: validate.NgValidators.notEqualTo2 }
    ];
    /** @type {?} */
    var FORMLY_VALIDATION_MESSAGES = [
        { name: 'required', message: validate.NgValidateMessages.required },
        { name: 'maxlength', message: validate.NgValidateMessages.maxlength },
        { name: 'minlength', message: validate.NgValidateMessages.minlength },
        { name: 'min', message: validate.NgValidateMessages.min },
        { name: 'max', message: validate.NgValidateMessages.max },
        { name: 'pattern', message: validate.NgValidateMessages.pattern },
        { name: 'letter', message: validate.NgValidateMessages.letter },
        { name: 'digit', message: validate.NgValidateMessages.digit },
        { name: 'character', message: validate.NgValidateMessages.character },
        { name: 'chinese', message: validate.NgValidateMessages.chinese },
        { name: 'integer', message: validate.NgValidateMessages.integer },
        { name: 'number', message: validate.NgValidateMessages.number },
        { name: 'full', message: validate.NgValidateMessages.fullWidth },
        { name: 'half', message: validate.NgValidateMessages.halfWidth },
        { name: 'phone', message: validate.NgValidateMessages.phone },
        { name: 'idCard', message: validate.NgValidateMessages.idCard },
        { name: 'age', message: validate.NgValidateMessages.age },
        { name: 'password', message: validate.NgValidateMessages.password },
        { name: 'dateBefore', message: validate.NgValidateMessages.dateBefore },
        { name: 'dateAfter', message: validate.NgValidateMessages.dateAfter },
        { name: 'dataBetween', message: validate.NgValidateMessages.dataBetween },
        { name: 'condition', message: validate.NgValidateMessages.condition },
        { name: 'email', message: validate.NgValidateMessages.email },
        { name: 'not_matching', message: validate.NgValidateMessages.not_matching },
        { name: 'unique', message: validate.NgValidateMessages.unique },
        { name: 'rangeLength', message: validate.NgValidateMessages.rangeLength },
        { name: 'gt', message: validate.NgValidateMessages.gt },
        { name: 'gte', message: validate.NgValidateMessages.gte },
        { name: 'lt', message: validate.NgValidateMessages.lt },
        { name: 'lte', message: validate.NgValidateMessages.lte },
        { name: 'lte', message: validate.NgValidateMessages.lte },
        { name: 'range', message: validate.NgValidateMessages.range },
        { name: 'url', message: validate.NgValidateMessages.url },
        { name: 'date', message: validate.NgValidateMessages.date },
        { name: 'minDate', message: validate.NgValidateMessages.minDate },
        { name: 'maxDate', message: validate.NgValidateMessages.maxDate },
        { name: 'json', message: validate.NgValidateMessages.json },
        { name: 'base64', message: validate.NgValidateMessages.base64 },
        { name: 'equal', message: validate.NgValidateMessages.equal },
        { name: 'notEqual', message: validate.NgValidateMessages.notEqual },
        { name: 'equalTo', message: validate.NgValidateMessages.equalTo },
        { name: 'notEqualTo', message: validate.NgValidateMessages.notEqualTo }
    ];
    /** @type {?} */
    ...
    var FormlyUtils = /** @class */ (function () {
         ...
         */
            function (ctx, entity, nextSeqProps) {
                ...
                if (!currentValue) {
                    return core$1.DataUtils.getNextValue(__assign({}, nextSeqProps || {}, { apiEntry: entity.apiEntry })).pipe(operators.map(function (result) {
                        ctx.model[fieldName] = result;
                        return true;
                    }));
                }
                else {
                    return core$1.DataUtils.checkDistinct({
                        apiProps: {
         ...
         */
            function (formlyForm, fieldName, valueResolver) {
                ...
                if (!fieldValue) {
                    /** @type {?} */
                    var node = utils.TreeUtils.getSelectedNode(formlyForm && formlyForm['tableId']);
                    if (node) {
                        /** @type {?} */
                        var val = void 0;
                        if (valueResolver) {
         ...
         */
            function (formlyForm, fieldName) {
                return formlyForm.formControl(fieldName).valueChanges
                    .pipe(operators.takeUntil(formlyForm.destroyed$), operators.distinctUntilChanged());
            };
        /**
         * @param {?} ctx
         * @return {?}
         ...
         */
            function (ctx) {
                ...
                if (tableId) {
                    /** @type {?} */
                    var table = tableId && utils.StatesUtils.getValue(tableId);
     ...
     */
    /** @type {?} */
    var Er_FORMLY_CONFIG = new core.InjectionToken('Er_FORMLY_CONFIG');
        ...
        ErFormlyRootModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            ...
                            core$1.ErCoreModule,
                            validate.ErValidateModule,
                            core$2.FormlyModule.forRoot(ER_FORMLY_CONFIG)
                        ],
                        declarations: __spread(FORMLY_WRAPPER_COMPONENTS)
                    },] }
        ];
        /** @nocollapse */
        ErFormlyRootModule.ctorParameters = function () {
            return [
                { type: core$2.FormlyConfig },
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [Er_FORMLY_CONFIG,] }] }
            ];
        };
    ...
    exports.ErFormlyModule = ErFormlyModule;
    exports.ErFormlyRootModule = ErFormlyRootModule;
    exports.ErFormlyFieldType = ErFormlyFieldType;
    exports.ErFormlyFieldWrapper = ErFormlyFieldWrapper;
    exports.FormlyFormComponent = FormlyFormComponent;
    exports.Components = Components;
    exports.FORMLY_WRAPPER_COMPONENTS = FORMLY_WRAPPER_COMPONENTS;
    exports.DynamicWrapperComponent = DynamicWrapperComponent;
    exports.HorizontalWrapperComponent = HorizontalWrapperComponent;
    exports.PanelWrapperComponent = PanelWrapperComponent;
    exports.VerticalWrapperComponent = VerticalWrapperComponent;
    exports.FormlyTypes = FormlyTypes;
    exports.FormlyWrappers = FormlyWrappers;
    exports.ER_FORMLY_CONFIG = ER_FORMLY_CONFIG;
    exports.FormlyUtils = FormlyUtils;
    exports.ɵc = Directives;
    exports.ɵb = FormlyPropsBindDirective;
    exports.ɵa = Er_FORMLY_CONFIG;
    exports.ɵd = Pipes;
...
//# sourceMappingURL=er-formly.umd.js.map